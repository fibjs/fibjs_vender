...
.globl	_vpsm4_ex_set_encrypt_key

.align	5
_vpsm4_ex_set_encrypt_key:
...
.globl	_vpsm4_ex_set_decrypt_key

.align	5
_vpsm4_ex_set_decrypt_key:
	AARCH64_SIGN_LINK_REGISTER
	stp	x29,x30,[sp,#-16]!
	mov	w2,0
	bl	_vpsm4_ex_set_key
...
.globl	_vpsm4_ex_ecb_encrypt

.align	5
_vpsm4_ex_ecb_encrypt:
	AARCH64_SIGN_LINK_REGISTER
...
.globl	_vpsm4_ex_cbc_encrypt

.align	5
_vpsm4_ex_cbc_encrypt:
	AARCH64_VALID_CALL_TARGET
	lsr	x2,x2,4
	ldr	q26, Lsbox_magic
	ldr	q27, Lsbox_magic+16
...
.globl	_vpsm4_ex_ctr32_encrypt_blocks

.align	5
_vpsm4_ex_ctr32_encrypt_blocks:
	AARCH64_VALID_CALL_TARGET
	ld1	{v3.4s},[x4]
#ifndef __AARCH64EB__
	rev32	v3.16b,v3.16b
...
.globl	_vpsm4_ex_xts_encrypt_gb

.align	5
_vpsm4_ex_xts_encrypt_gb:
	AARCH64_SIGN_LINK_REGISTER
	stp	x15, x16, [sp, #-0x10]!
	stp	x17, x18, [sp, #-0x10]!
	stp	x19, x20, [sp, #-0x10]!
...
.globl	_vpsm4_ex_xts_encrypt

.align	5
_vpsm4_ex_xts_encrypt:
	AARCH64_SIGN_LINK_REGISTER
	stp	x15, x16, [sp, #-0x10]!
	stp	x17, x18, [sp, #-0x10]!
	stp	x19, x20, [sp, #-0x10]!
