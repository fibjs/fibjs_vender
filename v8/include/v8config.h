...
// Include C++20 standard library polyfills for older libstdc++ versions
#include "patch/std_polyfill.h"
...
// Note: Android NDK clang 17 crashes when [[clang::always_inline]] is used
// before case statements, so disable it for Android.
