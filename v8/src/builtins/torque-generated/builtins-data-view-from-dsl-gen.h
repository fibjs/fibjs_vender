...
class DataViewBuiltinsFromDSLAssembler: public DataViewBuiltinsAssembler {
 public:
  ...
  TNode<Smi> LoadDataViewUint8(TNode<JSArrayBuffer> p_buffer, TNode<IntPtrT> p_offset);
  TNode<Smi> LoadDataViewInt8(TNode<JSArrayBuffer> p_buffer, TNode<IntPtrT> p_offset);
  ...
  TNode<Number> LoadDataView32(TNode<JSArrayBuffer> p_buffer, TNode<IntPtrT> p_offset, TNode<BoolT> p_requested_little_endian, bool p_signed);
  TNode<Number> LoadDataViewFloat32(TNode<JSArrayBuffer> p_buffer, TNode<IntPtrT> p_offset, TNode<BoolT> p_requested_little_endian);
