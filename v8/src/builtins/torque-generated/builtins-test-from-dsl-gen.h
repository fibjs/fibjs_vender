...
class TestBuiltinsFromDSLAssembler: public TestBuiltinsAssembler {
 public:
  ...
  void LabelTestHelper1(Label* label_Label1_387);
  void LabelTestHelper2(Label* label_Label2_388, TVariable<Smi>* Label20_350);
  void LabelTestHelper3(Label* label_Label3_389, TVariable<String>* Label30_351, TVariable<Smi>* Label31_352);
  void TestConstexpr1();
  ...
  void LabelTestHelper4(bool p_flag, Label* label_Label4_423, Label* label_Label5_424);
  ...
  TNode<Object> GenericMacroTestWithLabels22UT12ATHeapObject5ATSmi(TNode<Object> p_param2, Label* label_Y_432);
  ...
  TNode<Object> GenericMacroTestWithLabels5ATSmi(TNode<Smi> p_param, Label* label_X_513);
};
