...
V8_EXPORT_PRIVATE static  exlib::fiber_local<int> code_space_write_nesting_level_;
  ...
  // permissions.
static  exlib::fiber_local<bool> is_key_permissions_initialized_for_current_thread_;
