...
// `constexpr`, so wrap it in a `#ifdef` block.\n// Also check for __cpp_lib_constexpr_algorithms to ensure the library supports it.
#if defined(__clang__) && defined(__cpp_lib_constexpr_algorithms)
