...
#endif
static  exlib::fiber_local<std::unordered_map<const TimedHistogram*, bool>> active_timer;
#if __clang__
#pragma clang diagnostic pop
#endif
  bool is_running = active_timer.get()[this];
  DCHECK_NE(is_running, expect_to_run);
  active_timer.get()[this] = !is_running;
  return true;
}
#endif
