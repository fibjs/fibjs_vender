...
compiler::TNode<Number> ConvertToRelativeIndex_1(compiler::CodeAssemblerState* state_, compiler::TNode<Number> p_index, compiler::TNode<Number> p_length) {
  ...
  if (block0.is_used()) {
    ...
    USE(tmp2);
    tmp2 = ca_.UncheckedCast<Number>(FromConstexpr20UT5ATSmi10HeapNumber17ATconstexpr_int31_137(state_, 0));
  ...
  if (block2.is_used()) {
    ...
    USE(tmp12);
    tmp12 = ca_.UncheckedCast<Number>(FromConstexpr20UT5ATSmi10HeapNumber17ATconstexpr_int31_137(state_, 0));
    compiler::TNode<Number> tmp13;
    USE(tmp13);
    tmp13 = ca_.UncheckedCast<Number>(Max_82(state_, compiler::TNode<Number>{tmp11}, compiler::TNode<Number>{tmp12}));
  ...
  if (block3.is_used()) {
    ...
    USE(tmp16);
    tmp16 = ca_.UncheckedCast<Number>(Min_81(state_, compiler::TNode<Number>{tmp14}, compiler::TNode<Number>{tmp15}));
...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ...
    compiler::TNode<Number> tmp10;
    USE(tmp10);
    tmp10 = ca_.UncheckedCast<Number>(ConvertToRelativeIndex_1(state_, compiler::TNode<Number>{tmp9}, compiler::TNode<Number>{tmp6}));
    ...
    compiler::TNode<Number> tmp14;
    USE(tmp14);
    tmp14 = ca_.UncheckedCast<Number>(ConvertToRelativeIndex_1(state_, compiler::TNode<Number>{tmp13}, compiler::TNode<Number>{tmp6}));
    ...
    USE(tmp15);
    tmp15 = ca_.UncheckedCast<IntPtrT>(FromConstexpr8ATintptr17ATconstexpr_int31_127(state_, 2));
    compiler::TNode<Object> tmp16;
    USE(tmp16);
    tmp16 = ca_.UncheckedCast<Object>(CodeStubAssembler(state_).GetArgumentValue(TorqueStructArguments{compiler::TNode<RawPtrT>{tmp2}, compiler::TNode<RawPtrT>{tmp3}, compiler::TNode<IntPtrT>{tmp4}}, compiler::TNode<IntPtrT>{tmp15}));
  ...
  if (block1.is_used()) {
    ...
    USE(tmp31);
    tmp31 = ca_.UncheckedCast<IntPtrT>(FromConstexpr8ATintptr17ATconstexpr_int31_127(state_, 2));
    compiler::TNode<Object> tmp32;
    USE(tmp32);
    tmp32 = ca_.UncheckedCast<Object>(CodeStubAssembler(state_).GetArgumentValue(TorqueStructArguments{compiler::TNode<RawPtrT>{tmp21}, compiler::TNode<RawPtrT>{tmp22}, compiler::TNode<IntPtrT>{tmp23}}, compiler::TNode<IntPtrT>{tmp31}));
  ...
  if (block2.is_used()) {
    ...
    USE(tmp46);
    tmp46 = ca_.UncheckedCast<Number>(ConvertToRelativeIndex_1(state_, compiler::TNode<Number>{tmp45}, compiler::TNode<Number>{tmp40}));
    ...
    USE(tmp49);
    tmp49 = ca_.UncheckedCast<Number>(Min_81(state_, compiler::TNode<Number>{tmp47}, compiler::TNode<Number>{tmp48}));
    ca_.SetSourcePosition("../../src/builtins/array-copywithin.tq", 48);
    compiler::TNode<Number> tmp50;
    USE(tmp50);
    tmp50 = ca_.UncheckedCast<Number>(FromConstexpr20UT5ATSmi10HeapNumber17ATconstexpr_int31_137(state_, 1));
  ...
  if (block3.is_used()) {
    ...
    USE(tmp150);
    tmp150 = ca_.UncheckedCast<Number>(FromConstexpr20UT5ATSmi10HeapNumber17ATconstexpr_int31_137(state_, -1));
    ...
    USE(tmp152);
    tmp152 = ca_.UncheckedCast<Number>(FromConstexpr20UT5ATSmi10HeapNumber17ATconstexpr_int31_137(state_, 1));
    ...
    USE(tmp155);
    tmp155 = ca_.UncheckedCast<Number>(FromConstexpr20UT5ATSmi10HeapNumber17ATconstexpr_int31_137(state_, 1));
  ...
  if (block12.is_used()) {
    ...
    USE(tmp187);
    tmp187 = ca_.UncheckedCast<Number>(FromConstexpr20UT5ATSmi10HeapNumber17ATconstexpr_int31_137(state_, 0));
    compiler::CodeAssemblerLabel label0(&ca_);
    compiler::CodeAssemblerLabel label1(&ca_);
  ...
  if (block16.is_used()) {
    ...
    USE(tmp272);
    tmp272 = ca_.UncheckedCast<Smi>(FromConstexpr14ATLanguageMode24ATconstexpr_LanguageMode_145(state_, LanguageMode::kStrict));
  ...
  if (block17.is_used()) {
    ...
    USE(tmp292);
    tmp292 = ca_.UncheckedCast<Number>(FromConstexpr20UT5ATSmi10HeapNumber17ATconstexpr_int31_137(state_, 1));
