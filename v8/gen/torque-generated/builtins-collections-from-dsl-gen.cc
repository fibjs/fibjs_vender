...
BaseBuiltinsFromDSLAssembler::KeyValuePair CollectionsBuiltinsFromDSLAssembler::LoadKeyValuePairNoSideEffects(compiler::TNode<Context> p_context, compiler::TNode<Object> p_o, compiler::CodeAssemblerLabel* label_MayHaveSideEffects) {
  ...
  if (block5.is_used()) {
    ...
    USE(tmp12);
    tmp12 = ca_.UncheckedCast<Smi>(CodeStubAssembler(state_).LoadFastJSArrayLength(TNode<JSArray>{tmp11}));
    compiler::TNode<FixedArrayBase> tmp13;
    USE(tmp13);
    tmp13 = ca_.UncheckedCast<FixedArrayBase>(CodeStubAssembler(state_).LoadElements(TNode<JSObject>{tmp11}));
    compiler::TNode<FixedArray> tmp14;
    USE(tmp14);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp14 = BaseBuiltinsFromDSLAssembler(state_).Cast12ATFixedArray(TNode<Context>{tmp7}, TNode<HeapObject>{tmp13}, &label0);
  ...
  if (block9.is_used()) {
    ...
    USE(tmp30);
    tmp30 = ca_.UncheckedCast<Smi>(BaseBuiltinsFromDSLAssembler(state_).FromConstexpr5ATSmi(0));
    compiler::TNode<BoolT> tmp31;
    USE(tmp31);
    tmp31 = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).SmiGreaterThan(TNode<Smi>{tmp26}, TNode<Smi>{tmp30}));
  ...
  if (block11.is_used()) {
    ...
    USE(tmp39);
    tmp39 = ca_.UncheckedCast<Object>(ArrayBuiltinsFromDSLAssembler(state_).LoadElementOrUndefined(TNode<FixedArray>{tmp38}, 0));
  ...
  if (block13.is_used()) {
    ...
    USE(tmp64);
    tmp64 = ca_.UncheckedCast<Smi>(BaseBuiltinsFromDSLAssembler(state_).FromConstexpr5ATSmi(1));
    compiler::TNode<BoolT> tmp65;
    USE(tmp65);
    tmp65 = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).SmiGreaterThan(TNode<Smi>{tmp60}, TNode<Smi>{tmp64}));
  ...
  if (block15.is_used()) {
    ...
    USE(tmp74);
    tmp74 = ca_.UncheckedCast<Object>(ArrayBuiltinsFromDSLAssembler(state_).LoadElementOrUndefined(TNode<FixedArray>{tmp72}, 1));
  ...
  if (block8.is_used()) {
    ...
    USE(tmp108);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp108 = BaseBuiltinsFromDSLAssembler(state_).Cast18ATFixedDoubleArray(TNode<Context>{tmp102}, TNode<HeapObject>{ca_.UncheckedCast<FixedArrayBase>(tmp107)}, &label0);
  ...
  if (block21.is_used()) {
    ...
    USE(tmp124);
    tmp124 = ca_.UncheckedCast<Smi>(BaseBuiltinsFromDSLAssembler(state_).FromConstexpr5ATSmi(0));
    compiler::TNode<BoolT> tmp125;
    USE(tmp125);
    tmp125 = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).SmiGreaterThan(TNode<Smi>{tmp120}, TNode<Smi>{tmp124}));
  ...
  if (block23.is_used()) {
    ...
    USE(tmp133);
    tmp133 = ca_.UncheckedCast<Object>(ArrayBuiltinsFromDSLAssembler(state_).LoadElementOrUndefined(TNode<FixedDoubleArray>{tmp132}, 0));
  ...
  if (block25.is_used()) {
    ...
    USE(tmp158);
    tmp158 = ca_.UncheckedCast<Smi>(BaseBuiltinsFromDSLAssembler(state_).FromConstexpr5ATSmi(1));
    compiler::TNode<BoolT> tmp159;
    USE(tmp159);
    tmp159 = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).SmiGreaterThan(TNode<Smi>{tmp154}, TNode<Smi>{tmp158}));
  ...
  if (block27.is_used()) {
    ...
    USE(tmp168);
    tmp168 = ca_.UncheckedCast<Object>(ArrayBuiltinsFromDSLAssembler(state_).LoadElementOrUndefined(TNode<FixedDoubleArray>{tmp166}, 1));
  ...
  if (block20.is_used()) {
    ...
    CodeStubAssembler(state_).Print("halting because of \'unreachable\' at ../../src/builtins/collections.tq:30:13");
  ...
  if (block4.is_used()) {
    ...
    USE(tmp205);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp205 = BaseBuiltinsFromDSLAssembler(state_).Cast12ATJSReceiver(TNode<Context>{tmp202}, TNode<Object>{ca_.UncheckedCast<Object>(tmp204)}, &label0);
  ...
  if (block32.is_used()) {
    ...
    CodeStubAssembler(state_).ThrowTypeError(TNode<Context>{tmp215}, MessageTemplate::kIteratorValueNotAnObject, TNode<Object>{ca_.UncheckedCast<Object>(tmp217)});
  }
  ...
  return BaseBuiltinsFromDSLAssembler::KeyValuePair{TNode<Object>{tmp218}, TNode<Object>{tmp219}};
}
...
BaseBuiltinsFromDSLAssembler::KeyValuePair CollectionsBuiltinsFromDSLAssembler::LoadKeyValuePair(compiler::TNode<Context> p_context, compiler::TNode<Object> p_o) {
  ...
  if (block0.is_used()) {
    ...
    USE(tmp3);
    compiler::CodeAssemblerLabel label0(&ca_);
    std::tie(tmp2, tmp3) = CollectionsBuiltinsFromDSLAssembler(state_).LoadKeyValuePairNoSideEffects(TNode<Context>{tmp0}, TNode<Object>{tmp1}, &label0).Flatten();
  ...
  if (block3.is_used()) {
    ...
    USE(tmp14);
    tmp14 = ca_.UncheckedCast<Smi>(BaseBuiltinsFromDSLAssembler(state_).Convert5ATSmi(0));
    compiler::TNode<Object> tmp15;
    USE(tmp15);
    tmp15 = ca_.UncheckedCast<Object>(CodeStubAssembler(state_).GetProperty(TNode<Context>{tmp12}, TNode<Object>{tmp13}, TNode<Object>{tmp14}));
    compiler::TNode<Smi> tmp16;
    USE(tmp16);
    tmp16 = ca_.UncheckedCast<Smi>(BaseBuiltinsFromDSLAssembler(state_).Convert5ATSmi(1));
    compiler::TNode<Object> tmp17;
    USE(tmp17);
    tmp17 = ca_.UncheckedCast<Object>(CodeStubAssembler(state_).GetProperty(TNode<Context>{tmp12}, TNode<Object>{tmp13}, TNode<Object>{tmp16}));
  ...
  return BaseBuiltinsFromDSLAssembler::KeyValuePair{TNode<Object>{tmp18}, TNode<Object>{tmp19}};
}
