...
const char* kBuiltinName_287(compiler::CodeAssemblerState* state_) {
...
TF_BUILTIN(StringRepeat, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    USE(tmp3);
    tmp3 = kEmptyString_73(state_);
    ca_.SetSourcePosition("../../src/builtins/string-repeat.tq", 14);
    ca_.SetSourcePosition("../../src/builtins/string-repeat.tq", 15);
    compiler::TNode<IntPtrT> tmp4;
    USE(tmp4);
    tmp4 = ca_.UncheckedCast<IntPtrT>(Convert8ATintptr5ATSmi_163(state_, compiler::TNode<Smi>{tmp2}));
  ...
  if (block3.is_used()) {
    ...
    USE(tmp11);
    tmp11 = ca_.UncheckedCast<BoolT>(FromConstexpr6ATbool16ATconstexpr_bool_144(state_, true));
  ...
  if (block1.is_used()) {
    ...
    USE(tmp18);
    tmp18 = ca_.UncheckedCast<IntPtrT>(FromConstexpr8ATintptr17ATconstexpr_int31_127(state_, 1));
    ...
    USE(tmp20);
    tmp20 = ca_.UncheckedCast<IntPtrT>(FromConstexpr8ATintptr17ATconstexpr_int31_127(state_, 1));
  ...
  if (block4.is_used()) {
    ...
    USE(tmp28);
    tmp28 = ca_.UncheckedCast<String>(StringAdd_83(state_, compiler::TNode<Context>{tmp22}, compiler::TNode<String>{tmp25}, compiler::TNode<String>{tmp26}));
  ...
  if (block5.is_used()) {
    ...
    USE(tmp35);
    tmp35 = ca_.UncheckedCast<IntPtrT>(FromConstexpr8ATintptr17ATconstexpr_int31_127(state_, 1));
  ...
  if (block7.is_used()) {
    ...
    USE(tmp51);
    tmp51 = ca_.UncheckedCast<String>(StringAdd_83(state_, compiler::TNode<Context>{tmp45}, compiler::TNode<String>{tmp49}, compiler::TNode<String>{tmp49}));
    ca_.SetSourcePosition("../../src/builtins/string-repeat.tq", 17);
...
TF_BUILTIN(StringPrototypeRepeat, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    compiler::TNode<String> tmp3;
    USE(tmp3);
    tmp3 = ca_.UncheckedCast<String>(FromConstexpr6String18ATconstexpr_string_133(state_, kBuiltinName_287(state_)));
    ...
    tmp6 = Cast5ATSmi_84(state_, compiler::TNode<Object>{tmp5}, &label0);
  ...
  if (block12.is_used()) {
    ...
    USE(tmp34);
    tmp34 = ca_.UncheckedCast<Smi>(FromConstexpr5ATSmi17ATconstexpr_int31_131(state_, 0));
  ...
  if (block15.is_used()) {
    ...
    USE(tmp43);
    tmp43 = ca_.UncheckedCast<Uint32T>(FromConstexpr8ATuint3217ATconstexpr_int31_140(state_, 0));
  ...
  if (block14.is_used()) {
    ...
    USE(tmp57);
    tmp57 = ca_.UncheckedCast<Smi>(FromConstexpr5ATSmi17ATconstexpr_int31_131(state_, String::kMaxLength));
  ...
  if (block8.is_used()) {
    ...
    USE(tmp77);
    tmp77 = ca_.UncheckedCast<Float64T>(LoadHeapNumberValue_450(state_, compiler::TNode<HeapNumber>{ca_.UncheckedCast<HeapNumber>(tmp76)}));
    ca_.SetSourcePosition("../../src/builtins/string-repeat.tq", 58);
    compiler::TNode<Float64T> tmp78;
    USE(tmp78);
    tmp78 = ca_.UncheckedCast<Float64T>(FromConstexpr9ATfloat6419ATconstexpr_float64_143(state_, V8_INFINITY));
  ...
  if (block20.is_used()) {
    ...
    USE(tmp87);
    tmp87 = ca_.UncheckedCast<Float64T>(FromConstexpr9ATfloat6417ATconstexpr_int31_142(state_, 0.0));
  ...
  if (block19.is_used()) {
    ...
    USE(tmp104);
    tmp104 = ca_.UncheckedCast<Uint32T>(FromConstexpr8ATuint3217ATconstexpr_int31_140(state_, 0));
