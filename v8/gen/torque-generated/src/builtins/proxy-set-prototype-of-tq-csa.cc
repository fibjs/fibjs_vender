...
TF_BUILTIN(ProxySetPrototypeOf, CodeStubAssembler) {
  ...
  if (block5.is_used()) {
    ...
    USE(tmp20);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp20 = GetMethod_217(state_, compiler::TNode<Context>{tmp12}, compiler::TNode<Object>{tmp17}, "setPrototypeOf", &label0);
  ...
  if (block12.is_used()) {
    ...
    USE(tmp103);
    tmp103 = ObjectIsExtensible_282(state_, compiler::TNode<Context>{tmp95}, compiler::TNode<Object>{tmp100});
    ca_.SetSourcePosition("../../src/builtins/proxy-set-prototype-of.tq", 51);
    compiler::TNode<Oddball> tmp104;
    USE(tmp104);
    tmp104 = True_66(state_);
  ...
  if (block18.is_used()) {
    ...
    USE(tmp125);
    tmp125 = ObjectGetPrototypeOf_285(state_, compiler::TNode<Context>{tmp116}, compiler::TNode<Object>{tmp121});
  ...
  if (block23.is_used()) {
    ...
    USE(tmp185);
    tmp185 = ObjectSetPrototypeOfThrow_287(state_, compiler::TNode<Context>{tmp179}, compiler::TNode<Object>{tmp183}, compiler::TNode<Object>{tmp184});
  ...
  if (block24.is_used()) {
    ...
    USE(tmp192);
    tmp192 = ObjectSetPrototypeOfDontThrow_288(state_, compiler::TNode<Context>{tmp186}, compiler::TNode<Object>{tmp190}, compiler::TNode<Object>{tmp191});
