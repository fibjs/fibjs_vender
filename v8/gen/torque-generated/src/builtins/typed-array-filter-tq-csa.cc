...
USE(parameter1);
  ...
  if (block4.is_used()) {
    ...
    CodeStubAssembler(state_).ThrowTypeError(compiler::TNode<Context>{tmp22}, MessageTemplate::kNotTypedArray, kBuiltinName_312(state_));
  }
  ...
  if (block3.is_used()) {
    ...
    USE(tmp30);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp30 = EnsureAttached_328(state_, compiler::TNode<JSTypedArray>{tmp29}, &label0);
  ...
  if (block7.is_used()) {
    ...
    USE(tmp48);
    tmp48 = Convert20UT5ATSmi10HeapNumber9ATuintptr_174(state_, compiler::TNode<UintPtrT>{tmp47});
    compiler::TNode<Smi> tmp49;
    USE(tmp49);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp49 = Cast5ATSmi_78(state_, compiler::TNode<Object>{tmp48}, &label0);
  ...
  if (block9.is_used()) {
    ...
    USE(tmp82);
    tmp82 = FromConstexpr8ATintptr17ATconstexpr_int31_122(state_, 0);
    ...
    USE(tmp84);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp84 = Cast71UT19ATCallableApiObject17ATCallableJSProxy15JSBoundFunction10JSFunction_1291(state_, compiler::TNode<Context>{tmp77}, compiler::TNode<Object>{tmp83}, &label0);
  ...
  if (block14.is_used()) {
    ...
    USE(tmp112);
    tmp112 = FromConstexpr8ATintptr17ATconstexpr_int31_122(state_, 0);
  ...
  if (block13.is_used()) {
    ...
    USE(tmp123);
    tmp123 = FromConstexpr8ATintptr17ATconstexpr_int31_122(state_, 1);
    ...
    USE(tmp127);
    std::tie(tmp125, tmp126, tmp127) = NewGrowableFixedArray_276(state_).Flatten();
    ...
    USE(tmp130);
    std::tie(tmp128, tmp129, tmp130) = NewAttachedJSTypedArrayWitness_329(state_, compiler::TNode<JSTypedArray>{tmp120}).Flatten();
    ca_.SetSourcePosition("../../src/builtins/typed-array-filter.tq", 41);
    compiler::TNode<Smi> tmp131;
    USE(tmp131);
    tmp131 = FromConstexpr5ATSmi17ATconstexpr_int31_126(state_, 0);
  ...
  if (block32.is_used()) {
    ...
    USE(tmp350);
    tmp350 = FromConstexpr8ATintptr17ATconstexpr_int31_122(state_, 1);
    ...
    USE(tmp353);
    tmp353 = FromConstexpr8ATintptr17ATconstexpr_int31_122(state_, 16);
    ...
    USE(tmp355);
    tmp355 = FromConstexpr8ATintptr17ATconstexpr_int31_122(state_, 0);
  ...
  if (block31.is_used()) {
    ...
    USE(tmp423);
    tmp423 = FromConstexpr8ATintptr17ATconstexpr_int31_122(state_, 1);
  ...
  if (block20.is_used()) {
    ...
    USE(tmp482);
    tmp482 = FromConstexpr5ATSmi17ATconstexpr_int31_126(state_, 1);
  ...
  if (block18.is_used()) {
    ...
    USE(tmp501);
    tmp501 = Convert13ATPositiveSmi8ATintptr_162(state_, compiler::TNode<IntPtrT>{tmp496});
    ...
    USE(tmp502);
    tmp502 = TypedArraySpeciesCreateByLength_309(state_, compiler::TNode<Context>{tmp487}, kBuiltinName_312(state_), compiler::TNode<JSTypedArray>{tmp489}, compiler::TNode<Smi>{tmp501});
    ...
    USE(tmp505);
    tmp505 = FromConstexpr8ATintptr17ATconstexpr_int31_122(state_, 0);
    ca_.SetSourcePosition("../../src/builtins/growable-fixed-array.tq", 18);
    ca_.SetSourcePosition("../../src/builtins/growable-fixed-array.tq", 17);
  ...
  if (block36.is_used()) {
    ...
    USE(tmp533);
    tmp533 = Convert5ATSmi8ATintptr_157(state_, compiler::TNode<IntPtrT>{tmp519});
  ...
  if (block2.is_used()) {
    ...
    CodeStubAssembler(state_).ThrowTypeError(compiler::TNode<Context>{tmp561}, MessageTemplate::kDetachedOperation, kBuiltinName_312(state_));
  }
}
