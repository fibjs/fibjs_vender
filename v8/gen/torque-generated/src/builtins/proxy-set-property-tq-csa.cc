...
TF_BUILTIN(ProxySetProperty, CodeStubAssembler) {
  ...
  if (block1.is_used()) {
    ...
    CallThrowTypeErrorIfStrict_289(state_, compiler::TNode<Context>{tmp6}, MessageTemplate::kProxyPrivate);
  ...
  if (block2.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/proxy-set-property.tq", 39);
    ...
    tmp19 = Cast10JSReceiver_115(state_, compiler::TNode<Context>{tmp12}, compiler::TNode<HeapObject>{tmp18}, &label0);
  ...
  if (block7.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/proxy-set-property.tq", 42);
    ...
    USE(tmp35);
    tmp35 = UnsafeCast10JSReceiver_1337(state_, compiler::TNode<Context>{tmp26}, compiler::TNode<Object>{tmp34});
    ca_.SetSourcePosition("../../src/builtins/proxy-set-property.tq", 46);
    compiler::TNode<HeapObject> tmp36;
    USE(tmp36);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp36 = GetMethod_217(state_, compiler::TNode<Context>{tmp26}, compiler::TNode<Object>{tmp32}, "set", &label0);
  ...
  if (block14.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/proxy-set-property.tq", 69);
    compiler::TNode<Object> tmp109;
    USE(tmp109);
    tmp109 = FromConstexpr20UT5ATSmi10HeapObject18ATconstexpr_string_142(state_, "set");
  ...
  if (block4.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/proxy-set-property.tq", 79);
