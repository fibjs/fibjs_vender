...
USE(parameter1);
  ...
  if (block9.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-some.tq", 21);
  ...
  if (block13.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-some.tq", 25);
...
USE(parameter1);
  ...
  if (block9.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-some.tq", 39);
  ...
  if (block17.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-some.tq", 45);
    compiler::TNode<Oddball> tmp175;
    USE(tmp175);
    tmp175 = True_66(state_);
  ...
  if (block18.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-some.tq", 48);
    compiler::TNode<Number> tmp187;
    USE(tmp187);
    tmp187 = FromConstexpr20UT5ATSmi10HeapNumber17ATconstexpr_int31_132(state_, 1);
    ...
    USE(tmp189);
    tmp189 = Undefined_65(state_);
    ca_.SetSourcePosition("../../src/builtins/array-some.tq", 52);
...
TF_BUILTIN(ArraySomeLoopContinuation, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-some.tq", 61);
  ...
  if (block1.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-some.tq", 67);
  ...
  if (block7.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-some.tq", 72);
    ...
    ca_.SetSourcePosition("../../src/builtins/array-some.tq", 75);
  ...
  if (block9.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-some.tq", 79);
  ...
  if (block4.is_used()) {
    ...
    compiler::TNode<Number> tmp118;
    USE(tmp118);
    tmp118 = FromConstexpr20UT5ATSmi10HeapNumber17ATconstexpr_int31_132(state_, 1);
  ...
  if (block2.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-some.tq", 85);
    compiler::TNode<Oddball> tmp130;
    USE(tmp130);
    tmp130 = False_67(state_);
...
compiler::TNode<Object> FastArraySome_41(compiler::CodeAssemblerState* state_, compiler::TNode<Context> p_context, compiler::TNode<JSReceiver> p_o, compiler::TNode<Number> p_len, compiler::TNode<HeapObject> p_callbackfn, compiler::TNode<Object> p_thisArg, compiler::CodeAssemblerLabel* label_Bailout, compiler::TypedCodeAssemblerVariable<Smi>* label_Bailout_parameter_0) {
  ...
  if (block7.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-some.tq", 94);
  ...
  if (block21.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-some.tq", 98);
  ...
  if (block36.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-some.tq", 106);
    compiler::TNode<Oddball> tmp452;
    USE(tmp452);
    tmp452 = True_66(state_);
  ...
  if (block14.is_used()) {
    ...
    USE(tmp483);
    tmp483 = FromConstexpr5ATSmi17ATconstexpr_int31_126(state_, 1);
  ...
  if (block12.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-some.tq", 109);
    compiler::TNode<Oddball> tmp499;
    USE(tmp499);
    tmp499 = False_67(state_);
  ...
  if (block2.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-some.tq", 88);
...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ...
    compiler::TNode<Object> tmp4;
    ca_.Bind(&block0, &tmp0, &tmp1, &tmp2, &tmp3, &tmp4);
    ca_.SetSourcePosition("../../src/builtins/array-some.tq", 117);
    compiler::TNode<Object> tmp5;
    USE(tmp5);
    tmp5 = RequireObjectCoercible_214(state_, compiler::TNode<Context>{tmp3}, compiler::TNode<Object>{tmp4}, "Array.prototype.some");
    ca_.SetSourcePosition("../../src/builtins/array-some.tq", 120);
    compiler::TNode<JSReceiver> tmp6;
    USE(tmp6);
    tmp6 = CodeStubAssembler(state_).ToObject_Inline(compiler::TNode<Context>{tmp3}, compiler::TNode<Object>{tmp4});
    ca_.SetSourcePosition("../../src/builtins/array-some.tq", 123);
    compiler::TNode<Number> tmp7;
    USE(tmp7);
  ...
  if (block4.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-some.tq", 129);
  ...
  if (block5.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-some.tq", 132);
  ...
  if (block9.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-some.tq", 136);
    compiler::TNode<Object> tmp83;
    USE(tmp83);
  ...
  if (block2.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-some.tq", 145);
