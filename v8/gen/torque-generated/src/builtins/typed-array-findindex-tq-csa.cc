...
const char* kBuiltinName_315(compiler::CodeAssemblerState* state_) {
...
compiler::TNode<Number> FindIndexAllElements_316(compiler::CodeAssemblerState* state_, compiler::TNode<Context> p_context, compiler::TNode<JSTypedArray> p_array, compiler::TNode<HeapObject> p_callbackfn, compiler::TNode<Object> p_thisArg) {
  compiler::CodeAssembler ca_(state_);
  ...
  if (block2.is_used()) {
    ...
    USE(tmp51);
    tmp51 = FromConstexpr5ATSmi17ATconstexpr_int31_126(state_, 0);
  ...
  if (block17.is_used()) {
    ...
    USE(tmp151);
    tmp151 = ToBoolean_213(state_, compiler::TNode<Object>{tmp150});
  ...
  if (block10.is_used()) {
    ...
    USE(tmp183);
    tmp183 = FromConstexpr5ATSmi17ATconstexpr_int31_126(state_, 1);
  ...
  if (block8.is_used()) {
    ...
    USE(tmp194);
    tmp194 = FromConstexpr20UT5ATSmi10HeapNumber17ATconstexpr_int31_132(state_, -1);
...
USE(parameter1);
  ...
  if (block11.is_used()) {
    ...
    USE(tmp55);
    tmp55 = FromConstexpr8ATintptr17ATconstexpr_int31_122(state_, 1);
    ...
    USE(tmp57);
    tmp57 = FindIndexAllElements_316(state_, compiler::TNode<Context>{tmp49}, compiler::TNode<JSTypedArray>{tmp52}, compiler::TNode<HeapObject>{tmp54}, compiler::TNode<Object>{tmp56});
  ...
  if (block6.is_used()) {
    ...
    USE(tmp63);
    tmp63 = FromConstexpr8ATintptr17ATconstexpr_int31_122(state_, 0);
  ...
  if (block4.is_used()) {
    ...
    CodeStubAssembler(state_).ThrowTypeError(compiler::TNode<Context>{tmp68}, MessageTemplate::kNotTypedArray, kBuiltinName_315(state_));
  }
  ...
  if (block2.is_used()) {
    ...
    CodeStubAssembler(state_).ThrowTypeError(compiler::TNode<Context>{tmp73}, MessageTemplate::kDetachedOperation, kBuiltinName_315(state_));
  }
}
