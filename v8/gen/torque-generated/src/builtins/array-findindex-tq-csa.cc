...
USE(parameter1);
  ...
  if (block9.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-findindex.tq", 21);
  ...
  if (block13.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-findindex.tq", 24);
...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-findindex.tq", 35);
    CodeStubAssembler(state_).Unreachable();
  }
}
...
USE(parameter1);
  ...
  if (block9.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-findindex.tq", 52);
  ...
  if (block17.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-findindex.tq", 60);
  ...
  if (block18.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-findindex.tq", 64);
...
TF_BUILTIN(ArrayFindIndexLoopContinuation, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    ca_.Bind(&block0, &tmp0, &tmp1, &tmp2, &tmp3, &tmp4, &tmp5, &tmp6);
    ca_.SetSourcePosition("../../src/builtins/array-findindex.tq", 73);
  ...
  if (block1.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-findindex.tq", 79);
    compiler::TNode<Object> tmp43;
    USE(tmp43);
    ...
    ca_.SetSourcePosition("../../src/builtins/array-findindex.tq", 83);
    ca_.SetSourcePosition("../../src/builtins/array-findindex.tq", 87);
  ...
  if (block7.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-findindex.tq", 88);
  ...
  if (block2.is_used()) {
    ...
    USE(tmp84);
    tmp84 = Convert5ATSmi17ATconstexpr_int31_1292(state_, -1);
...
compiler::TNode<Number> FastArrayFindIndex_6(compiler::CodeAssemblerState* state_, compiler::TNode<Context> p_context, compiler::TNode<JSReceiver> p_o, compiler::TNode<Number> p_len, compiler::TNode<HeapObject> p_callbackfn, compiler::TNode<Object> p_thisArg, compiler::CodeAssemblerLabel* label_Bailout, compiler::TypedCodeAssemblerVariable<Smi>* label_Bailout_parameter_0) {
  ...
  if (block3.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-findindex.tq", 101);
  ...
  if (block7.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-findindex.tq", 105);
  ...
  if (block36.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-findindex.tq", 114);
  ...
  if (block12.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-findindex.tq", 118);
    compiler::TNode<Number> tmp526;
    USE(tmp526);
    tmp526 = FromConstexpr20UT5ATSmi10HeapNumber17ATconstexpr_int31_132(state_, -1);
...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ...
    compiler::TNode<Object> tmp5;
    USE(tmp5);
    tmp5 = RequireObjectCoercible_214(state_, compiler::TNode<Context>{tmp3}, compiler::TNode<Object>{tmp4}, "Array.prototype.findIndex");
...
compiler::TNode<Smi> Convert5ATSmi17ATconstexpr_int31_1292(compiler::CodeAssemblerState* state_, int31_t p_i) {
  ...
  if (block0.is_used()) {
    ...
    USE(tmp0);
    tmp0 = FromConstexpr5ATSmi17ATconstexpr_int31_126(state_, p_i);
