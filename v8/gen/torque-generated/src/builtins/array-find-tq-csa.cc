...
USE(parameter1);
  ...
  if (block9.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-find.tq", 21);
  ...
  if (block13.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-find.tq", 24);
...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-find.tq", 35);
    CodeStubAssembler(state_).Unreachable();
  }
}
...
USE(parameter1);
  ...
  if (block5.is_used()) {
    ...
    USE(tmp86);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp86 = Cast20UT5ATSmi10HeapNumber_80(state_, compiler::TNode<Object>{tmp80}, &label0);
  ...
  if (block9.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-find.tq", 52);
  ...
  if (block13.is_used()) {
    ...
    USE(tmp180);
    tmp180 = ToBoolean_213(state_, compiler::TNode<Object>{tmp175});
  ...
  if (block18.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-find.tq", 64);
...
TF_BUILTIN(ArrayFindLoopContinuation, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    ca_.Bind(&block0, &tmp0, &tmp1, &tmp2, &tmp3, &tmp4, &tmp5, &tmp6);
    ca_.SetSourcePosition("../../src/builtins/array-find.tq", 72);
  ...
  if (block1.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-find.tq", 78);
    compiler::TNode<Object> tmp43;
    USE(tmp43);
    ...
    ca_.SetSourcePosition("../../src/builtins/array-find.tq", 82);
    ca_.SetSourcePosition("../../src/builtins/array-find.tq", 86);
    compiler::TNode<BoolT> tmp45;
    USE(tmp45);
    tmp45 = ToBoolean_213(state_, compiler::TNode<Object>{tmp44});
  ...
  if (block7.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-find.tq", 87);
  ...
  if (block4.is_used()) {
    ...
    USE(tmp74);
    tmp74 = FromConstexpr20UT5ATSmi10HeapNumber17ATconstexpr_int31_132(state_, 1);
...
compiler::TNode<Object> FastArrayFind_5(compiler::CodeAssemblerState* state_, compiler::TNode<Context> p_context, compiler::TNode<JSReceiver> p_o, compiler::TNode<Number> p_len, compiler::TNode<HeapObject> p_callbackfn, compiler::TNode<Object> p_thisArg, compiler::CodeAssemblerLabel* label_Bailout, compiler::TypedCodeAssemblerVariable<Smi>* label_Bailout_parameter_0) {
  ...
  if (block3.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-find.tq", 100);
  ...
  if (block7.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-find.tq", 104);
  ...
  if (block29.is_used()) {
    ...
    USE(tmp272);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp272 = LoadElementNoHole16FixedDoubleArray_209(state_, compiler::TNode<Context>{tmp270}, compiler::TNode<JSArray>{tmp261}, compiler::TNode<Smi>{tmp271}, &label0);
  ...
  if (block30.is_used()) {
    ...
    USE(tmp338);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp338 = LoadElementNoHole10FixedArray_208(state_, compiler::TNode<Context>{tmp336}, compiler::TNode<JSArray>{tmp327}, compiler::TNode<Smi>{tmp337}, &label0);
  ...
  if (block36.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-find.tq", 113);
    compiler::TNode<BoolT> tmp463;
    USE(tmp463);
    tmp463 = ToBoolean_213(state_, compiler::TNode<Object>{tmp462});
  ...
  if (block14.is_used()) {
    ...
    USE(tmp510);
    tmp510 = FromConstexpr5ATSmi17ATconstexpr_int31_126(state_, 1);
  ...
  if (block12.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-find.tq", 117);
    compiler::TNode<Oddball> tmp526;
    USE(tmp526);
    tmp526 = Undefined_65(state_);
...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ...
    compiler::TNode<Object> tmp4;
    ca_.Bind(&block0, &tmp0, &tmp1, &tmp2, &tmp3, &tmp4);
    ca_.SetSourcePosition("../../src/builtins/array-find.tq", 125);
    compiler::TNode<Object> tmp5;
    USE(tmp5);
    tmp5 = RequireObjectCoercible_214(state_, compiler::TNode<Context>{tmp3}, compiler::TNode<Object>{tmp4}, "Array.prototype.find");
    ca_.SetSourcePosition("../../src/builtins/array-find.tq", 128);
    compiler::TNode<JSReceiver> tmp6;
    USE(tmp6);
    tmp6 = CodeStubAssembler(state_).ToObject_Inline(compiler::TNode<Context>{tmp3}, compiler::TNode<Object>{tmp4});
    ca_.SetSourcePosition("../../src/builtins/array-find.tq", 131);
  ...
  if (block5.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-find.tq", 141);
  ...
  if (block12.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-find.tq", 149);
    compiler::TNode<Object> tmp122;
  ...
  if (block2.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-find.tq", 153);
    compiler::TNode<IntPtrT> tmp128;
    USE(tmp128);
    tmp128 = FromConstexpr8ATintptr17ATconstexpr_int31_122(state_, 0);
    compiler::TNode<Object> tmp129;
    USE(tmp129);
