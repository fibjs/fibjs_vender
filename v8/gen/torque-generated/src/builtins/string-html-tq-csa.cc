...
TF_BUILTIN(CreateHTML, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    USE(tmp7);
    tmp7 = FromConstexpr6String18ATconstexpr_string_128(state_, "<");
    compiler::TNode<String> tmp8;
    USE(tmp8);
    tmp8 = StringAdd_77(state_, compiler::TNode<Context>{tmp0}, compiler::TNode<String>{tmp7}, compiler::TNode<String>{tmp3});
  ...
  if (block1.is_used()) {
    ...
    USE(tmp21);
    tmp21 = FromConstexpr6String18ATconstexpr_string_128(state_, " ");
    compiler::TNode<String> tmp22;
    USE(tmp22);
    tmp22 = StringAdd_77(state_, compiler::TNode<Context>{tmp11}, compiler::TNode<String>{tmp18}, compiler::TNode<String>{tmp21});
    compiler::TNode<String> tmp23;
    USE(tmp23);
    tmp23 = StringAdd_77(state_, compiler::TNode<Context>{tmp11}, compiler::TNode<String>{tmp22}, compiler::TNode<String>{tmp15});
    compiler::TNode<String> tmp24;
    USE(tmp24);
    tmp24 = FromConstexpr6String18ATconstexpr_string_128(state_, "=\"");
    compiler::TNode<String> tmp25;
    USE(tmp25);
    tmp25 = StringAdd_77(state_, compiler::TNode<Context>{tmp11}, compiler::TNode<String>{tmp23}, compiler::TNode<String>{tmp24});
    compiler::TNode<String> tmp26;
    USE(tmp26);
    tmp26 = StringAdd_77(state_, compiler::TNode<Context>{tmp11}, compiler::TNode<String>{tmp25}, compiler::TNode<String>{tmp20});
    compiler::TNode<String> tmp27;
    USE(tmp27);
    tmp27 = FromConstexpr6String18ATconstexpr_string_128(state_, "\"");
    compiler::TNode<String> tmp28;
    USE(tmp28);
    tmp28 = StringAdd_77(state_, compiler::TNode<Context>{tmp11}, compiler::TNode<String>{tmp26}, compiler::TNode<String>{tmp27});
    ca_.SetSourcePosition("../../src/builtins/string-html.tq", 14);
  ...
  if (block2.is_used()) {
    ...
    USE(tmp37);
    tmp37 = FromConstexpr6String18ATconstexpr_string_128(state_, ">");
    compiler::TNode<String> tmp38;
    USE(tmp38);
    tmp38 = StringAdd_77(state_, compiler::TNode<Context>{tmp29}, compiler::TNode<String>{tmp36}, compiler::TNode<String>{tmp37});
    compiler::TNode<String> tmp39;
    USE(tmp39);
    tmp39 = StringAdd_77(state_, compiler::TNode<Context>{tmp29}, compiler::TNode<String>{tmp38}, compiler::TNode<String>{tmp35});
    compiler::TNode<String> tmp40;
    USE(tmp40);
    tmp40 = FromConstexpr6String18ATconstexpr_string_128(state_, "</");
    compiler::TNode<String> tmp41;
    USE(tmp41);
    tmp41 = StringAdd_77(state_, compiler::TNode<Context>{tmp29}, compiler::TNode<String>{tmp39}, compiler::TNode<String>{tmp40});
    compiler::TNode<String> tmp42;
    USE(tmp42);
    tmp42 = StringAdd_77(state_, compiler::TNode<Context>{tmp29}, compiler::TNode<String>{tmp41}, compiler::TNode<String>{tmp32});
    compiler::TNode<String> tmp43;
    USE(tmp43);
    tmp43 = FromConstexpr6String18ATconstexpr_string_128(state_, ">");
    compiler::TNode<String> tmp44;
    USE(tmp44);
    tmp44 = StringAdd_77(state_, compiler::TNode<Context>{tmp29}, compiler::TNode<String>{tmp42}, compiler::TNode<String>{tmp43});
...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ...
    compiler::TNode<String> tmp7;
    USE(tmp7);
    tmp7 = FromConstexpr6String18ATconstexpr_string_128(state_, "String.prototype.anchor");
    compiler::TNode<String> tmp8;
    USE(tmp8);
    tmp8 = FromConstexpr6String18ATconstexpr_string_128(state_, "a");
    compiler::TNode<String> tmp9;
    USE(tmp9);
    tmp9 = FromConstexpr6String18ATconstexpr_string_128(state_, "name");
...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ...
    USE(tmp5);
    tmp5 = kEmptyString_68(state_);
    compiler::TNode<String> tmp6;
    USE(tmp6);
    tmp6 = kEmptyString_68(state_);
    ca_.SetSourcePosition("../../src/builtins/string-html.tq", 34);
    compiler::TNode<String> tmp7;
    USE(tmp7);
    tmp7 = FromConstexpr6String18ATconstexpr_string_128(state_, "String.prototype.big");
    compiler::TNode<String> tmp8;
    USE(tmp8);
    tmp8 = FromConstexpr6String18ATconstexpr_string_128(state_, "big");
    compiler::TNode<String> tmp9;
...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ...
    compiler::TNode<String> tmp7;
    USE(tmp7);
    tmp7 = FromConstexpr6String18ATconstexpr_string_128(state_, "String.prototype.blink");
    compiler::TNode<String> tmp8;
    USE(tmp8);
    tmp8 = FromConstexpr6String18ATconstexpr_string_128(state_, "blink");
    compiler::TNode<String> tmp9;
    tmp9 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltin(Builtins::kCreateHTML, tmp3, tmp4, tmp7, tmp8, tmp5, tmp6));
    USE(tmp9);
    arguments.PopAndReturn(tmp9);
...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ...
    compiler::TNode<String> tmp7;
    USE(tmp7);
    tmp7 = FromConstexpr6String18ATconstexpr_string_128(state_, "String.prototype.bold");
    compiler::TNode<String> tmp8;
    USE(tmp8);
    tmp8 = FromConstexpr6String18ATconstexpr_string_128(state_, "b");
    compiler::TNode<String> tmp9;
    tmp9 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltin(Builtins::kCreateHTML, tmp3, tmp4, tmp7, tmp8, tmp5, tmp6));
    USE(tmp9);
    arguments.PopAndReturn(tmp9);
...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ...
    compiler::TNode<String> tmp7;
    USE(tmp7);
    tmp7 = FromConstexpr6String18ATconstexpr_string_128(state_, "String.prototype.fontcolor");
    compiler::TNode<String> tmp8;
    USE(tmp8);
    tmp8 = FromConstexpr6String18ATconstexpr_string_128(state_, "font");
    compiler::TNode<String> tmp9;
    USE(tmp9);
    tmp9 = FromConstexpr6String18ATconstexpr_string_128(state_, "color");
    compiler::TNode<String> tmp10;
    tmp10 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltin(Builtins::kCreateHTML, tmp3, tmp4, tmp7, tmp8, tmp9, tmp6));
    USE(tmp10);
    arguments.PopAndReturn(tmp10);
...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ...
    compiler::TNode<String> tmp7;
    USE(tmp7);
    tmp7 = FromConstexpr6String18ATconstexpr_string_128(state_, "String.prototype.fontsize");
    compiler::TNode<String> tmp8;
    USE(tmp8);
    tmp8 = FromConstexpr6String18ATconstexpr_string_128(state_, "font");
    compiler::TNode<String> tmp9;
    USE(tmp9);
    tmp9 = FromConstexpr6String18ATconstexpr_string_128(state_, "size");
    compiler::TNode<String> tmp10;
    tmp10 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltin(Builtins::kCreateHTML, tmp3, tmp4, tmp7, tmp8, tmp9, tmp6));
    USE(tmp10);
    arguments.PopAndReturn(tmp10);
...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ...
    compiler::TNode<String> tmp7;
    USE(tmp7);
    tmp7 = FromConstexpr6String18ATconstexpr_string_128(state_, "String.prototype.fixed");
    compiler::TNode<String> tmp8;
    USE(tmp8);
    tmp8 = FromConstexpr6String18ATconstexpr_string_128(state_, "tt");
    compiler::TNode<String> tmp9;
    tmp9 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltin(Builtins::kCreateHTML, tmp3, tmp4, tmp7, tmp8, tmp5, tmp6));
    USE(tmp9);
    arguments.PopAndReturn(tmp9);
...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ...
    compiler::TNode<String> tmp7;
    USE(tmp7);
    tmp7 = FromConstexpr6String18ATconstexpr_string_128(state_, "String.prototype.italics");
    compiler::TNode<String> tmp8;
    USE(tmp8);
    tmp8 = FromConstexpr6String18ATconstexpr_string_128(state_, "i");
    compiler::TNode<String> tmp9;
    tmp9 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltin(Builtins::kCreateHTML, tmp3, tmp4, tmp7, tmp8, tmp5, tmp6));
    USE(tmp9);
    arguments.PopAndReturn(tmp9);
...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ...
    compiler::TNode<String> tmp7;
    USE(tmp7);
    tmp7 = FromConstexpr6String18ATconstexpr_string_128(state_, "String.prototype.link");
    compiler::TNode<String> tmp8;
    USE(tmp8);
    tmp8 = FromConstexpr6String18ATconstexpr_string_128(state_, "a");
    compiler::TNode<String> tmp9;
    USE(tmp9);
    tmp9 = FromConstexpr6String18ATconstexpr_string_128(state_, "href");
    compiler::TNode<String> tmp10;
    tmp10 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltin(Builtins::kCreateHTML, tmp3, tmp4, tmp7, tmp8, tmp9, tmp6));
    USE(tmp10);
    arguments.PopAndReturn(tmp10);
...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ...
    compiler::TNode<String> tmp7;
    USE(tmp7);
    tmp7 = FromConstexpr6String18ATconstexpr_string_128(state_, "String.prototype.small");
    compiler::TNode<String> tmp8;
    USE(tmp8);
    tmp8 = FromConstexpr6String18ATconstexpr_string_128(state_, "small");
    compiler::TNode<String> tmp9;
    tmp9 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltin(Builtins::kCreateHTML, tmp3, tmp4, tmp7, tmp8, tmp5, tmp6));
    USE(tmp9);
    arguments.PopAndReturn(tmp9);
...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ...
    compiler::TNode<String> tmp7;
    USE(tmp7);
    tmp7 = FromConstexpr6String18ATconstexpr_string_128(state_, "String.prototype.strike");
    compiler::TNode<String> tmp8;
    USE(tmp8);
    tmp8 = FromConstexpr6String18ATconstexpr_string_128(state_, "strike");
    compiler::TNode<String> tmp9;
    tmp9 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltin(Builtins::kCreateHTML, tmp3, tmp4, tmp7, tmp8, tmp5, tmp6));
    USE(tmp9);
    arguments.PopAndReturn(tmp9);
...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ...
    compiler::TNode<String> tmp7;
    USE(tmp7);
    tmp7 = FromConstexpr6String18ATconstexpr_string_128(state_, "String.prototype.sub");
    compiler::TNode<String> tmp8;
    USE(tmp8);
    tmp8 = FromConstexpr6String18ATconstexpr_string_128(state_, "sub");
    compiler::TNode<String> tmp9;
    tmp9 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltin(Builtins::kCreateHTML, tmp3, tmp4, tmp7, tmp8, tmp5, tmp6));
    USE(tmp9);
    arguments.PopAndReturn(tmp9);
...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ...
    compiler::TNode<String> tmp7;
    USE(tmp7);
    tmp7 = FromConstexpr6String18ATconstexpr_string_128(state_, "String.prototype.sup");
    compiler::TNode<String> tmp8;
    USE(tmp8);
    tmp8 = FromConstexpr6String18ATconstexpr_string_128(state_, "sup");
    compiler::TNode<String> tmp9;
    tmp9 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltin(Builtins::kCreateHTML, tmp3, tmp4, tmp7, tmp8, tmp5, tmp6));
    USE(tmp9);
    arguments.PopAndReturn(tmp9);
