...
compiler::TNode<Number> GetFromIndex_21(compiler::CodeAssemblerState* state_, compiler::TNode<Context> p_context, compiler::TNode<Number> p_length, TorqueStructArguments p_arguments) {
  ...
  if (block0.is_used()) {
    ...
    USE(tmp5);
    tmp5 = FromConstexpr8ATintptr17ATconstexpr_int31_122(state_, 2);
    compiler::TNode<BoolT> tmp6;
    USE(tmp6);
  ...
  if (block2.is_used()) {
    ...
    USE(tmp12);
    tmp12 = FromConstexpr20UT5ATSmi10HeapNumber17ATconstexpr_int31_132(state_, 1);
  ...
  if (block3.is_used()) {
    ...
    USE(tmp19);
    tmp19 = FromConstexpr8ATintptr17ATconstexpr_int31_122(state_, 1);
    compiler::TNode<Object> tmp20;
    USE(tmp20);
  ...
  if (block6.is_used()) {
    ...
    USE(tmp59);
    tmp59 = FromConstexpr20UT5ATSmi10HeapNumber17ATconstexpr_int31_132(state_, 1);
    ...
    USE(tmp61);
    tmp61 = Min_75(state_, compiler::TNode<Number>{tmp57}, compiler::TNode<Number>{tmp60});
    ca_.SetSourcePosition("../../src/builtins/array-lastindexof.tq", 71);
...
compiler::TNode<Object> TryFastArrayLastIndexOf_22(compiler::CodeAssemblerState* state_, compiler::TNode<Context> p_context, compiler::TNode<JSReceiver> p_receiver, compiler::TNode<Object> p_searchElement, compiler::TNode<Number> p_from, compiler::CodeAssemblerLabel* label_Slow) {
  ...
  if (block0.is_used()) {
    ...
    USE(tmp4);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp4 = Cast13ATFastJSArray_110(state_, compiler::TNode<Context>{tmp0}, compiler::TNode<HeapObject>{tmp1}, &label0);
  ...
  if (block3.is_used()) {
    ...
    USE(tmp17);
    tmp17 = FromConstexpr5ATSmi17ATconstexpr_int31_126(state_, 0);
  ...
  if (block6.is_used()) {
    ...
    USE(tmp32);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp32 = Cast5ATSmi_78(state_, compiler::TNode<Object>{tmp29}, &label0);
  ...
  if (block9.is_used()) {
    ...
    USE(tmp60);
    tmp60 = FastArrayLastIndexOf10FixedArray_1306(state_, compiler::TNode<Context>{tmp52}, compiler::TNode<JSArray>{tmp56}, compiler::TNode<Smi>{tmp58}, compiler::TNode<Object>{tmp54});
  ...
  if (block10.is_used()) {
    ...
    USE(tmp69);
    tmp69 = FastArrayLastIndexOf16FixedDoubleArray_1307(state_, compiler::TNode<Context>{tmp61}, compiler::TNode<JSArray>{tmp65}, compiler::TNode<Smi>{tmp67}, compiler::TNode<Object>{tmp63});
...
compiler::TNode<Object> GenericArrayLastIndexOf_23(compiler::CodeAssemblerState* state_, compiler::TNode<Context> p_context, compiler::TNode<JSReceiver> p_object, compiler::TNode<Object> p_searchElement, compiler::TNode<Number> p_from) {
  ...
  if (block4.is_used()) {
    ...
    USE(tmp9);
    tmp9 = FromConstexpr20UT5ATSmi10HeapNumber17ATconstexpr_int31_132(state_, 0);
    compiler::CodeAssemblerLabel label0(&ca_);
    compiler::CodeAssemblerLabel label1(&ca_);
  ...
  if (block8.is_used()) {
    ...
    USE(tmp62);
    tmp62 = FromConstexpr20UT5ATSmi10HeapNumber17ATconstexpr_int31_132(state_, 1);
    compiler::TNode<Number> tmp63;
    USE(tmp63);
...
USE(parameter1);
  ...
  if (block2.is_used()) {
    ...
    USE(tmp25);
    tmp25 = FromConstexpr8ATintptr17ATconstexpr_int31_122(state_, 0);
    compiler::TNode<Object> tmp26;
    USE(tmp26);
...
compiler::TNode<Smi> FastArrayLastIndexOf10FixedArray_1306(compiler::CodeAssemblerState* state_, compiler::TNode<Context> p_context, compiler::TNode<JSArray> p_array, compiler::TNode<Smi> p_from, compiler::TNode<Object> p_searchElement) {
  ...
  if (block7.is_used()) {
    ...
    USE(tmp88);
    tmp88 = FromConstexpr5ATSmi17ATconstexpr_int31_126(state_, 1);
  ...
  if (block5.is_used()) {
    ...
    USE(tmp96);
    tmp96 = FromConstexpr5ATSmi17ATconstexpr_int31_126(state_, -1);
