...
TF_BUILTIN(StringToList, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    USE(tmp9);
    tmp9 = UnsafeCast10FixedArray_1343(state_, compiler::TNode<Context>{tmp0}, compiler::TNode<Object>{tmp8});
  ...
  if (block2.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/string.tq", 53);
...
void GenerateStringAt_331(compiler::CodeAssemblerState* state_, compiler::TNode<Context> p_context, compiler::TNode<Object> p_receiver, compiler::TNode<Object> p_position, const char* p_methodName, compiler::CodeAssemblerLabel* label_IfInBounds, compiler::TypedCodeAssemblerVariable<String>* label_IfInBounds_parameter_0, compiler::TypedCodeAssemblerVariable<IntPtrT>* label_IfInBounds_parameter_1, compiler::TypedCodeAssemblerVariable<IntPtrT>* label_IfInBounds_parameter_2, compiler::CodeAssemblerLabel* label_IfOutOfBounds) {
  ...
  if (block0.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/string.tq", 61);
  ...
  if (block4.is_used()) {
    ...
    USE(tmp17);
    tmp17 = UnsafeCast5ATSmi_1344(state_, compiler::TNode<Context>{tmp12}, compiler::TNode<Object>{tmp16});
  ...
  if (block1.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/string.tq", 56);
...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ...
    compiler::TNode<Object> tmp2;
    ca_.Bind(&block0, &tmp0, &tmp1, &tmp2);
    ca_.SetSourcePosition("../../src/builtins/string.tq", 93);
    compiler::TypedCodeAssemblerVariable<String> result_0_0(&ca_);
    compiler::TypedCodeAssemblerVariable<IntPtrT> result_0_1(&ca_);
    compiler::TypedCodeAssemblerVariable<IntPtrT> result_0_2(&ca_);
    compiler::CodeAssemblerLabel label0(&ca_);
  ...
  if (block4.is_used()) {
    ...
    compiler::TNode<IntPtrT> tmp21;
    ca_.Bind(&block4, &tmp16, &tmp17, &tmp18, &tmp19, &tmp20, &tmp21);
    ca_.SetSourcePosition("../../src/builtins/string.tq", 97);
    compiler::TNode<Int32T> tmp22;
    USE(tmp22);
    tmp22 = CodeStubAssembler(state_).StringCharCodeAt(compiler::TNode<String>{tmp19}, compiler::TNode<IntPtrT>{tmp20});
  ...
  if (block2.is_used()) {
    ...
    compiler::TNode<Object> tmp26;
    ca_.Bind(&block2, &tmp24, &tmp25, &tmp26);
    ca_.SetSourcePosition("../../src/builtins/string.tq", 101);
...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ...
    compiler::TNode<Object> tmp2;
    ca_.Bind(&block0, &tmp0, &tmp1, &tmp2);
    ca_.SetSourcePosition("../../src/builtins/string.tq", 109);
    compiler::TypedCodeAssemblerVariable<String> result_0_0(&ca_);
    compiler::TypedCodeAssemblerVariable<IntPtrT> result_0_1(&ca_);
    compiler::TypedCodeAssemblerVariable<IntPtrT> result_0_2(&ca_);
    compiler::CodeAssemblerLabel label0(&ca_);
  ...
  if (block4.is_used()) {
    ...
    compiler::TNode<IntPtrT> tmp21;
    ca_.Bind(&block4, &tmp16, &tmp17, &tmp18, &tmp19, &tmp20, &tmp21);
    ca_.SetSourcePosition("../../src/builtins/string.tq", 115);
    compiler::TNode<Int32T> tmp22;
    USE(tmp22);
  ...
  if (block2.is_used()) {
    ...
    compiler::TNode<Object> tmp26;
    ca_.Bind(&block2, &tmp24, &tmp25, &tmp26);
    ca_.SetSourcePosition("../../src/builtins/string.tq", 119);
...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/string.tq", 128);
    ...
    USE(tmp7);
    tmp7 = Convert8ATintptr8ATintptr_1404(state_, compiler::TNode<IntPtrT>{tmp2});
...
USE(parameter3);
  ...
  if (block0.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/string.tq", 147);
    compiler::TNode<IntPtrT> tmp7;
    USE(tmp7);
    tmp7 = Convert8ATintptr8ATintptr_1404(state_, compiler::TNode<IntPtrT>{tmp2});
    ca_.SetSourcePosition("../../src/builtins/string.tq", 148);
    ca_.SetSourcePosition("../../src/builtins/string.tq", 150);
    compiler::TNode<IntPtrT> tmp8;
    USE(tmp8);
    tmp8 = FromConstexpr8ATintptr17ATconstexpr_int31_148(state_, 0);
  ...
  if (block2.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/string.tq", 156);
  ...
  if (block4.is_used()) {
    ...
    USE(tmp42);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp42 = Cast6Symbol_1405(state_, compiler::TNode<Context>{tmp34}, compiler::TNode<Object>{tmp41}, &label0);
  ...
  if (block7.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/string.tq", 161);
    ca_.SetSourcePosition("../../src/builtins/string.tq", 158);
  ...
  if (block5.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/string.tq", 166);
  ...
  if (block3.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/string.tq", 169);
  ...
  if (block11.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/string.tq", 174);
    compiler::TNode<JSReceiver> tmp128;
    USE(tmp128);
    tmp128 = UnsafeCast10JSReceiver_1391(state_, compiler::TNode<Context>{tmp122}, compiler::TNode<Object>{tmp124});
    ...
    ca_.SetSourcePosition("../../src/builtins/string.tq", 176);
    ...
    USE(tmp131);
    tmp131 = UnsafeCast18JSPrimitiveWrapper_1392(state_, compiler::TNode<Context>{tmp122}, compiler::TNode<Object>{tmp130});
...
TF_BUILTIN(StringAddConvertLeft, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    ca_.Bind(&block0, &tmp0, &tmp1, &tmp2);
    ca_.SetSourcePosition("../../src/builtins/string.tq", 183);
...
TF_BUILTIN(StringAddConvertRight, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    compiler::TNode<Object> tmp2;
    ca_.Bind(&block0, &tmp0, &tmp1, &tmp2);
    ca_.SetSourcePosition("../../src/builtins/string.tq", 188);
    compiler::TNode<Object> tmp3;
    USE(tmp3);
