...
TF_BUILTIN(StringToList, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    ca_.Bind(&block0, &tmp0, &tmp1);
    ca_.SetSourcePosition("../../src/builtins/string.tq", 30);
    ...
    USE(tmp10);
    tmp10 = FromConstexpr5ATSmi17ATconstexpr_int31_126(state_, 0);
  ...
  if (block1.is_used()) {
    ...
    StoreFixedArrayDirect_189(state_, compiler::TNode<FixedArray>{tmp26}, compiler::TNode<Smi>{tmp27}, compiler::TNode<Object>{tmp30});
    ...
    ca_.SetSourcePosition("../../src/builtins/string.tq", 46);
  ...
  if (block2.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/string.tq", 50);
...
void GenerateStringAt_295(compiler::CodeAssemblerState* state_, compiler::TNode<Context> p_context, compiler::TNode<Object> p_receiver, compiler::TNode<Object> p_position, const char* p_methodName, compiler::CodeAssemblerLabel* label_IfInBounds, compiler::TypedCodeAssemblerVariable<String>* label_IfInBounds_parameter_0, compiler::TypedCodeAssemblerVariable<IntPtrT>* label_IfInBounds_parameter_1, compiler::TypedCodeAssemblerVariable<IntPtrT>* label_IfInBounds_parameter_2, compiler::CodeAssemblerLabel* label_IfOutOfBounds) {
  ...
  if (block0.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/string.tq", 60);
    compiler::TNode<String> tmp3;
    USE(tmp3);
    tmp3 = FromConstexpr6String18ATconstexpr_string_128(state_, p_methodName);
  ...
  if (block4.is_used()) {
    ...
    USE(tmp17);
    tmp17 = UnsafeCast5ATSmi_1296(state_, compiler::TNode<Context>{tmp12}, compiler::TNode<Object>{tmp16});
    ...
    USE(tmp20);
    tmp20 = Convert9ATuintptr8ATintptr_176(state_, compiler::TNode<IntPtrT>{tmp18});
    compiler::TNode<UintPtrT> tmp21;
    USE(tmp21);
    tmp21 = Convert9ATuintptr8ATintptr_176(state_, compiler::TNode<IntPtrT>{tmp19});
  ...
  if (block1.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/string.tq", 55);
...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ...
    compiler::TNode<Object> tmp2;
    ca_.Bind(&block0, &tmp0, &tmp1, &tmp2);
    ca_.SetSourcePosition("../../src/builtins/string.tq", 77);
    ...
    GenerateStringAt_295(state_, compiler::TNode<Context>{tmp0}, compiler::TNode<Object>{tmp1}, compiler::TNode<Object>{tmp2}, "String.prototype.charAt", &label0, &result_0_0, &result_0_1, &result_0_2, &label1);
    if (label0.is_used()) {
      ca_.Bind(&label0);
  ...
  if (block4.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/string.tq", 81);
  ...
  if (block2.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/string.tq", 85);
    compiler::TNode<String> tmp27;
    USE(tmp27);
    tmp27 = kEmptyString_68(state_);
...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ...
    compiler::CodeAssemblerLabel label0(&ca_);
    compiler::CodeAssemblerLabel label1(&ca_);
    GenerateStringAt_295(state_, compiler::TNode<Context>{tmp0}, compiler::TNode<Object>{tmp1}, compiler::TNode<Object>{tmp2}, "String.prototype.charCodeAt", &label0, &result_0_0, &result_0_1, &result_0_2, &label1);
    if (label0.is_used()) {
      ca_.Bind(&label0);
      ca_.Goto(&block5, tmp0, tmp1, tmp2, tmp1, tmp2, result_0_0.value(), result_0_1.value(), result_0_2.value());
    }
  ...
  if (block4.is_used()) {
    ...
    USE(tmp23);
    tmp23 = Convert5ATSmi7ATint32_149(state_, compiler::TNode<Int32T>{tmp22});
    CodeStubAssembler(state_).Return(tmp23);
  }
...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ...
    compiler::TNode<Object> tmp2;
    ca_.Bind(&block0, &tmp0, &tmp1, &tmp2);
    ca_.SetSourcePosition("../../src/builtins/string.tq", 111);
    compiler::TypedCodeAssemblerVariable<String> result_0_0(&ca_);
    compiler::TypedCodeAssemblerVariable<IntPtrT> result_0_1(&ca_);
    compiler::TypedCodeAssemblerVariable<IntPtrT> result_0_2(&ca_);
    compiler::CodeAssemblerLabel label0(&ca_);
    compiler::CodeAssemblerLabel label1(&ca_);
    GenerateStringAt_295(state_, compiler::TNode<Context>{tmp0}, compiler::TNode<Object>{tmp1}, compiler::TNode<Object>{tmp2}, "String.prototype.codePointAt", &label0, &result_0_0, &result_0_1, &result_0_2, &label1);
    if (label0.is_used()) {
      ca_.Bind(&label0);
      ca_.Goto(&block5, tmp0, tmp1, tmp2, tmp1, tmp2, result_0_0.value(), result_0_1.value(), result_0_2.value());
    }
  ...
  if (block4.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/string.tq", 118);
    compiler::TNode<Smi> tmp23;
    USE(tmp23);
    tmp23 = Convert5ATSmi7ATint32_149(state_, compiler::TNode<Int32T>{tmp22});
    CodeStubAssembler(state_).Return(tmp23);
  ...
  if (block2.is_used()) {
    ...
    compiler::TNode<Object> tmp26;
    ca_.Bind(&block2, &tmp24, &tmp25, &tmp26);
    ca_.SetSourcePosition("../../src/builtins/string.tq", 121);
    compiler::TNode<Oddball> tmp27;
    USE(tmp27);
    tmp27 = Undefined_65(state_);
    CodeStubAssembler(state_).Return(tmp27);
  }
}
...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ...
    USE(tmp5);
    tmp5 = FromConstexpr6String18ATconstexpr_string_128(state_, "String.prototype.concat");
    ...
    USE(tmp7);
    tmp7 = Convert8ATintptr8ATintptr_1346(state_, compiler::TNode<IntPtrT>{tmp2});
  ...
  if (block1.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/string.tq", 136);
    compiler::TNode<String> tmp28;
    USE(tmp28);
    tmp28 = StringAdd_77(state_, compiler::TNode<Context>{tmp21}, compiler::TNode<String>{tmp23}, compiler::TNode<String>{tmp27});
    ca_.SetSourcePosition("../../src/builtins/string.tq", 134);
  ...
  if (block4.is_used()) {
    ...
    compiler::TNode<IntPtrT> tmp37;
    USE(tmp37);
    tmp37 = FromConstexpr8ATintptr17ATconstexpr_int31_122(state_, 1);
    compiler::TNode<IntPtrT> tmp38;
    USE(tmp38);
  ...
  if (block2.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/string.tq", 138);
