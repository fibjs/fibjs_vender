...
compiler::TNode<Object> ReduceAllElements_320(compiler::CodeAssemblerState* state_, compiler::TNode<Context> p_context, compiler::TNode<JSTypedArray> p_array, compiler::TNode<HeapObject> p_callbackfn, compiler::TNode<Object> p_initialValue) {
  ...
  if (block21.is_used()) {
    ...
    CodeStubAssembler(state_).ThrowTypeError(compiler::TNode<Context>{tmp221}, MessageTemplate::kReduceNoInitial, kBuiltinName_319(state_));
  }
...
USE(parameter1);
  ...
  if (block15.is_used()) {
    ...
    compiler::TNode<Object> tmp94;
    USE(tmp94);
    tmp94 = ReduceAllElements_320(state_, compiler::TNode<Context>{tmp88}, compiler::TNode<JSTypedArray>{tmp91}, compiler::TNode<HeapObject>{tmp92}, compiler::TNode<Object>{tmp93});
  ...
  if (block4.is_used()) {
    ...
    CodeStubAssembler(state_).ThrowTypeError(compiler::TNode<Context>{tmp105}, MessageTemplate::kNotTypedArray, kBuiltinName_319(state_));
  }
  ...
  if (block2.is_used()) {
    ...
    CodeStubAssembler(state_).ThrowTypeError(compiler::TNode<Context>{tmp110}, MessageTemplate::kDetachedOperation, kBuiltinName_319(state_));
  }
}
