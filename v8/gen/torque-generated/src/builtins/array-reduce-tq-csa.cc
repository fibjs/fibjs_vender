...
USE(parameter1);
  ...
  if (block9.is_used()) {
    ...
    compiler::TNode<Number> tmp104;
    ca_.Bind(&block9, &tmp96, &tmp97, &tmp98, &tmp99, &tmp100, &tmp101, &tmp102, &tmp103, &tmp104);
    ca_.SetSourcePosition("../../src/builtins/array-reduce.tq", 60);
    compiler::TNode<Number> tmp105;
    USE(tmp105);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp105 = Cast20UT5ATSmi10HeapNumber_80(state_, compiler::TNode<Object>{tmp100}, &label0);
  ...
  if (block13.is_used()) {
    ...
    tmp146 = CodeStubAssembler(state_).CallBuiltin(Builtins::kArrayReduceLoopContinuation, tmp136, tmp142, tmp143, tmp141, tmp142, tmp144, tmp145);
    USE(tmp146);
    ca_.SetSourcePosition("../../src/builtins/array-reduce.tq", 65);
    CodeStubAssembler(state_).Return(tmp146);
  }
}
...
TF_BUILTIN(ArrayReduceLoopContinuation, CodeStubAssembler) {
  ...
  if (block9.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-reduce.tq", 89);
    ca_.SetSourcePosition("../../src/builtins/array-reduce.tq", 87);
  ...
  if (block10.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-reduce.tq", 94);
    compiler::TNode<Oddball> tmp85;
    USE(tmp85);
    tmp85 = Undefined_65(state_);
    compiler::TNode<Object> tmp86;
    USE(tmp86);
    ...
    ca_.SetSourcePosition("../../src/builtins/array-reduce.tq", 93);
    ca_.SetSourcePosition("../../src/builtins/array-reduce.tq", 87);
  ...
  if (block4.is_used()) {
    ...
    USE(tmp117);
    tmp117 = FromConstexpr20UT5ATSmi10HeapNumber17ATconstexpr_int31_132(state_, 1);
  ...
  if (block2.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-reduce.tq", 104);
    compiler::TNode<Oddball> tmp128;
    USE(tmp128);
    tmp128 = TheHole_63(state_);
  ...
  if (block12.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-reduce.tq", 105);
  ...
  if (block13.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-reduce.tq", 107);
...
compiler::TNode<Object> FastArrayReduce_27(compiler::CodeAssemblerState* state_, compiler::TNode<Context> p_context, compiler::TNode<JSReceiver> p_o, compiler::TNode<Number> p_len, compiler::TNode<HeapObject> p_callbackfn, compiler::TNode<Object> p_initialAccumulator, compiler::CodeAssemblerLabel* label_Bailout, compiler::TypedCodeAssemblerVariable<Number>* label_Bailout_parameter_0, compiler::TypedCodeAssemblerVariable<Object>* label_Bailout_parameter_1) {
  ...
  if (block0.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-reduce.tq", 115);
    ca_.SetSourcePosition("../../src/builtins/array-reduce.tq", 116);
  ...
  if (block4.is_used()) {
    ...
    USE(tmp27);
    tmp27 = FromConstexpr20UT5ATSmi10HeapNumber17ATconstexpr_int31_132(state_, 0);
  ...
  if (block3.is_used()) {
    ...
    USE(tmp35);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp35 = Cast20ATFastJSArrayForRead_111(state_, compiler::TNode<Context>{tmp28}, compiler::TNode<HeapObject>{tmp29}, &label0);
  ...
  if (block8.is_used()) {
    ...
    USE(tmp57);
    tmp57 = FromConstexpr20UT5ATSmi10HeapNumber17ATconstexpr_int31_132(state_, 0);
  ...
  if (block7.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-reduce.tq", 119);
    ...
    USE(tmp68);
    std::tie(tmp65, tmp66, tmp67, tmp68) = NewFastJSArrayForReadWitness_211(state_, compiler::TNode<JSArray>{tmp64}).Flatten();
    ca_.SetSourcePosition("../../src/builtins/array-reduce.tq", 122);
    compiler::TNode<Smi> tmp69;
    USE(tmp69);
    tmp69 = FromConstexpr5ATSmi17ATconstexpr_int31_126(state_, 0);
  ...
  if (block25.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-reduce.tq", 128);
  ...
  if (block32.is_used()) {
    ...
    USE(tmp294);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp294 = LoadElementNoHole16FixedDoubleArray_209(state_, compiler::TNode<Context>{tmp292}, compiler::TNode<JSArray>{tmp287}, compiler::TNode<Smi>{tmp293}, &label0);
  ...
  if (block33.is_used()) {
    ...
    USE(tmp345);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp345 = LoadElementNoHole10FixedArray_208(state_, compiler::TNode<Context>{tmp343}, compiler::TNode<JSArray>{tmp338}, compiler::TNode<Smi>{tmp344}, &label0);
  ...
  if (block29.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-reduce.tq", 129);
    compiler::TNode<Oddball> tmp422;
    USE(tmp422);
    tmp422 = TheHole_63(state_);
  ...
  if (block40.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-reduce.tq", 133);
    compiler::TNode<Oddball> tmp450;
    USE(tmp450);
    tmp450 = Undefined_65(state_);
    ca_.SetSourcePosition("../../src/builtins/base.tq", 2820);
  ...
  if (block42.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-reduce.tq", 132);
  ...
  if (block14.is_used()) {
    ...
    USE(tmp497);
    tmp497 = FromConstexpr5ATSmi17ATconstexpr_int31_126(state_, 1);
  ...
  if (block44.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-reduce.tq", 140);
...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ...
    compiler::TNode<Object> tmp5;
    USE(tmp5);
    tmp5 = RequireObjectCoercible_214(state_, compiler::TNode<Context>{tmp3}, compiler::TNode<Object>{tmp4}, "Array.prototype.reduce");
    ca_.SetSourcePosition("../../src/builtins/array-reduce.tq", 151);
    compiler::TNode<JSReceiver> tmp6;
    USE(tmp6);
    tmp6 = CodeStubAssembler(state_).ToObject_Inline(compiler::TNode<Context>{tmp3}, compiler::TNode<Object>{tmp4});
    ca_.SetSourcePosition("../../src/builtins/array-reduce.tq", 154);
    compiler::TNode<Number> tmp7;
    USE(tmp7);
    tmp7 = GetLengthProperty_216(state_, compiler::TNode<Context>{tmp3}, compiler::TNode<Object>{tmp6});
    ca_.SetSourcePosition("../../src/builtins/array-reduce.tq", 157);
  ...
  if (block3.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-reduce.tq", 158);
  ...
  if (block4.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-reduce.tq", 160);
  ...
  if (block2.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-reduce.tq", 179);
