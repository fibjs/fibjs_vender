...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ...
    tmp4 = Cast10JSReceiver_1290(state_, compiler::TNode<Context>{tmp0}, compiler::TNode<Object>{tmp1}, &label0);
  ...
  if (block1.is_used()) {
    ...
    USE(tmp25);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp25 = Cast71UT19ATCallableApiObject17ATCallableJSProxy15JSBoundFunction10JSFunction_1291(state_, compiler::TNode<Context>{tmp20}, compiler::TNode<Object>{tmp22}, &label0);
  ...
  if (block5.is_used()) {
    ...
    USE(tmp50);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp50 = Cast20UT5ATSmi10HeapNumber_80(state_, compiler::TNode<Object>{tmp47}, &label0);
  ...
  if (block9.is_used()) {
    ...
    USE(tmp79);
    tmp79 = TheHole_63(state_);
    ca_.SetSourcePosition("../../src/builtins/array-reduce-right.tq", 24);
    compiler::TNode<Number> tmp80;
    USE(tmp80);
    tmp80 = FromConstexpr20UT5ATSmi10HeapNumber17ATconstexpr_int31_132(state_, 0);
...
USE(parameter1);
  ...
  if (block5.is_used()) {
    ...
    USE(tmp68);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp68 = Cast20UT5ATSmi10HeapNumber_80(state_, compiler::TNode<Object>{tmp63}, &label0);
  ...
  if (block9.is_used()) {
    ...
    USE(tmp105);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp105 = Cast20UT5ATSmi10HeapNumber_80(state_, compiler::TNode<Object>{tmp100}, &label0);
...
TF_BUILTIN(ArrayReduceRightLoopContinuation, CodeStubAssembler) {
  ...
  if (block3.is_used()) {
    ...
    USE(tmp16);
    tmp16 = FromConstexpr20UT5ATSmi10HeapNumber17ATconstexpr_int31_132(state_, 0);
    compiler::CodeAssemblerLabel label0(&ca_);
  ...
  if (block10.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-reduce-right.tq", 95);
    compiler::TNode<Oddball> tmp84;
    USE(tmp84);
    tmp84 = Undefined_65(state_);
    ...
    ca_.SetSourcePosition("../../src/builtins/array-reduce-right.tq", 94);
    ca_.SetSourcePosition("../../src/builtins/array-reduce-right.tq", 88);
  ...
  if (block4.is_used()) {
    ...
    USE(tmp116);
    tmp116 = FromConstexpr20UT5ATSmi10HeapNumber17ATconstexpr_int31_132(state_, 1);
  ...
  if (block2.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-reduce-right.tq", 105);
  ...
  if (block12.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-reduce-right.tq", 106);
  ...
  if (block13.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-reduce-right.tq", 108);
...
compiler::TNode<Object> FastArrayReduceRight_26(compiler::CodeAssemblerState* state_, compiler::TNode<Context> p_context, compiler::TNode<JSReceiver> p_o, compiler::TNode<Number> p_len, compiler::TNode<HeapObject> p_callbackfn, compiler::TNode<Object> p_initialAccumulator, compiler::CodeAssemblerLabel* label_Bailout, compiler::TypedCodeAssemblerVariable<Number>* label_Bailout_parameter_0, compiler::TypedCodeAssemblerVariable<Object>* label_Bailout_parameter_1) {
  ...
  if (block0.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-reduce-right.tq", 116);
    compiler::TNode<Smi> tmp5;
    USE(tmp5);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp5 = Cast5ATSmi_78(state_, compiler::TNode<Object>{tmp2}, &label0);
  ...
  if (block4.is_used()) {
    ...
    USE(tmp27);
    tmp27 = FromConstexpr20UT5ATSmi10HeapNumber17ATconstexpr_int31_132(state_, 1);
  ...
  if (block3.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-reduce-right.tq", 117);
    compiler::TNode<JSArray> tmp36;
    USE(tmp36);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp36 = Cast20ATFastJSArrayForRead_111(state_, compiler::TNode<Context>{tmp29}, compiler::TNode<HeapObject>{tmp30}, &label0);
  ...
  if (block8.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-reduce-right.tq", 118);
    compiler::TNode<Number> tmp61;
    USE(tmp61);
    tmp61 = FromConstexpr20UT5ATSmi10HeapNumber17ATconstexpr_int31_132(state_, 1);
  ...
  if (block7.is_used()) {
    ...
    USE(tmp74);
    std::tie(tmp71, tmp72, tmp73, tmp74) = NewFastJSArrayForReadWitness_211(state_, compiler::TNode<JSArray>{tmp70}).Flatten();
    ca_.SetSourcePosition("../../src/builtins/array-reduce-right.tq", 122);
  ...
  if (block30.is_used()) {
    ...
    USE(tmp290);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp290 = LoadElementNoHole16FixedDoubleArray_209(state_, compiler::TNode<Context>{tmp288}, compiler::TNode<JSArray>{tmp283}, compiler::TNode<Smi>{tmp289}, &label0);
  ...
  if (block31.is_used()) {
    ...
    USE(tmp344);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp344 = LoadElementNoHole10FixedArray_208(state_, compiler::TNode<Context>{tmp342}, compiler::TNode<JSArray>{tmp337}, compiler::TNode<Smi>{tmp343}, &label0);
  ...
  if (block27.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-reduce-right.tq", 129);
    compiler::TNode<Oddball> tmp426;
    USE(tmp426);
    tmp426 = TheHole_63(state_);
  ...
  if (block38.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-reduce-right.tq", 133);
    compiler::TNode<Oddball> tmp456;
    USE(tmp456);
    tmp456 = Undefined_65(state_);
    ca_.SetSourcePosition("../../src/builtins/base.tq", 2820);
  ...
  if (block14.is_used()) {
    ...
    USE(tmp506);
    tmp506 = FromConstexpr5ATSmi17ATconstexpr_int31_126(state_, 1);
  ...
  if (block42.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-reduce-right.tq", 140);
...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ...
    compiler::TNode<Object> tmp5;
    USE(tmp5);
    tmp5 = RequireObjectCoercible_214(state_, compiler::TNode<Context>{tmp3}, compiler::TNode<Object>{tmp4}, "Array.prototype.reduceRight");
    ...
    ca_.SetSourcePosition("../../src/builtins/array-reduce-right.tq", 154);
    compiler::TNode<Number> tmp7;
    USE(tmp7);
    tmp7 = GetLengthProperty_216(state_, compiler::TNode<Context>{tmp3}, compiler::TNode<Object>{tmp6});
    ca_.SetSourcePosition("../../src/builtins/array-reduce-right.tq", 157);
  ...
  if (block3.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-reduce-right.tq", 158);
  ...
  if (block4.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-reduce-right.tq", 160);
  ...
  if (block5.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-reduce-right.tq", 167);
  ...
  if (block9.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-reduce-right.tq", 170);
    compiler::TNode<Object> tmp83;
    USE(tmp83);
  ...
  if (block2.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-reduce-right.tq", 179);
