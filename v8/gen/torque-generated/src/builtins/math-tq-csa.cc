...
TF_BUILTIN(MathAcos, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    USE(tmp4);
    tmp4 = Convert9ATfloat6420UT5ATSmi10HeapNumber_167(state_, compiler::TNode<Number>{tmp3});
    ...
    USE(tmp6);
    tmp6 = Convert20UT5ATSmi10HeapNumber9ATfloat64_172(state_, compiler::TNode<Float64T>{tmp5});
...
TF_BUILTIN(MathAtan2, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    compiler::TNode<Float64T> tmp5;
    USE(tmp5);
    tmp5 = Convert9ATfloat6420UT5ATSmi10HeapNumber_167(state_, compiler::TNode<Number>{tmp4});
    ...
    USE(tmp7);
    tmp7 = Convert9ATfloat6420UT5ATSmi10HeapNumber_167(state_, compiler::TNode<Number>{tmp6});
    ...
    USE(tmp9);
    tmp9 = Convert20UT5ATSmi10HeapNumber9ATfloat64_172(state_, compiler::TNode<Float64T>{tmp8});
...
TF_BUILTIN(MathClz32, CodeStubAssembler) {
  ...
  if (block3.is_used()) {
    ...
    USE(tmp20);
    tmp20 = Convert7ATint325ATSmi_165(state_, compiler::TNode<Smi>{tmp19});
    ca_.SetSourcePosition("../../src/builtins/math.tq", 88);
  ...
  if (block1.is_used()) {
    ...
    USE(tmp35);
    tmp35 = Convert20UT5ATSmi10HeapNumber7ATint32_146(state_, compiler::TNode<Int32T>{tmp34});
...
TF_BUILTIN(MathFround, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    USE(tmp4);
    tmp4 = Convert9ATfloat3220UT5ATSmi10HeapNumber_171(state_, compiler::TNode<Number>{tmp3});
    ca_.SetSourcePosition("../../src/builtins/math.tq", 139);
    compiler::TNode<Float64T> tmp5;
    USE(tmp5);
    tmp5 = Convert9ATfloat649ATfloat32_169(state_, compiler::TNode<Float32T>{tmp4});
...
TF_BUILTIN(MathSign, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    compiler::TNode<Float64T> tmp5;
    USE(tmp5);
    tmp5 = FromConstexpr9ATfloat6417ATconstexpr_int31_137(state_, 0);
  ...
  if (block2.is_used()) {
    ...
    USE(tmp18);
    tmp18 = FromConstexpr9ATfloat6417ATconstexpr_int31_137(state_, 0);
  ...
  if (block4.is_used()) {
    ...
    USE(tmp25);
    tmp25 = FromConstexpr20UT5ATSmi10HeapNumber17ATconstexpr_int31_132(state_, 1);
