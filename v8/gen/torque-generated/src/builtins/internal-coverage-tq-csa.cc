...
compiler::TNode<FixedArray> GetCoverageInfo_277(compiler::CodeAssemblerState* state_, compiler::TNode<Context> p_context, compiler::TNode<JSFunction> p_function, compiler::CodeAssemblerLabel* label_IfNoCoverageInfo) {
  ...
  if (block0.is_used()) {
    ...
    tmp6 = Cast9DebugInfo_117(state_, compiler::TNode<Context>{tmp0}, compiler::TNode<HeapObject>{tmp5}, &label0);
  ...
  if (block3.is_used()) {
    ...
    USE(tmp25);
    tmp25 = FromConstexpr5ATSmi17ATconstexpr_int31_126(state_, DebugInfo::kHasCoverageInfo);
    compiler::TNode<Smi> tmp26;
    USE(tmp26);
    tmp26 = CodeStubAssembler(state_).SmiAnd(compiler::TNode<Smi>{tmp24}, compiler::TNode<Smi>{tmp25});
    compiler::TNode<Smi> tmp27;
    USE(tmp27);
    tmp27 = FromConstexpr5ATSmi17ATconstexpr_int31_126(state_, 0);
  ...
  if (block8.is_used()) {
    ...
    USE(tmp39);
    tmp39 = UnsafeCast14ATCoverageInfo_1342(state_, compiler::TNode<Context>{tmp33}, compiler::TNode<Object>{tmp38});
...
void IncrementBlockCount_280(compiler::CodeAssemblerState* state_, compiler::TNode<Context> p_context, compiler::TNode<FixedArray> p_coverageInfo, compiler::TNode<Smi> p_slot) {
  ...
  if (block0.is_used()) {
    ...
    compiler::TNode<Smi> tmp3;
    USE(tmp3);
    tmp3 = FirstIndexForSlot_279(state_, compiler::TNode<Context>{tmp0}, compiler::TNode<Smi>{tmp2});
    ca_.SetSourcePosition("../../src/builtins/internal-coverage.tq", 48);
    compiler::TNode<Smi> tmp4;
    USE(tmp4);
    tmp4 = FromConstexpr5ATSmi17ATconstexpr_int31_126(state_, CoverageInfo::kSlotBlockCountIndex);
    compiler::TNode<Smi> tmp5;
    USE(tmp5);
...
TF_BUILTIN(IncBlockCounter, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    USE(tmp3);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp3 = GetCoverageInfo_277(state_, compiler::TNode<Context>{tmp0}, compiler::TNode<JSFunction>{tmp1}, &label0);
  ...
  if (block1.is_used()) {
    ...
    IncrementBlockCount_280(state_, compiler::TNode<Context>{tmp17}, compiler::TNode<FixedArray>{tmp20}, compiler::TNode<Smi>{tmp19});
