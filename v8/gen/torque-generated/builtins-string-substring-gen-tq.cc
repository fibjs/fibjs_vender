...
compiler::TNode<Smi> ToSmiBetweenZeroAnd_289(compiler::CodeAssemblerState* state_, compiler::TNode<Context> p_context, compiler::TNode<Object> p_value, compiler::TNode<Smi> p_limit) {
  ...
  if (block0.is_used()) {
    ...
    tmp4 = Cast5ATSmi_84(state_, compiler::TNode<Object>{tmp3}, &label0);
  ...
  if (block6.is_used()) {
    ...
    USE(tmp25);
    tmp25 = ca_.UncheckedCast<Smi>(FromConstexpr5ATSmi17ATconstexpr_int31_131(state_, 0));
  ...
  if (block11.is_used()) {
    ...
    USE(tmp45);
    tmp45 = ca_.UncheckedCast<Smi>(FromConstexpr5ATSmi17ATconstexpr_int31_131(state_, 0));
  ...
  if (block3.is_used()) {
    ...
    USE(tmp64);
    tmp64 = ca_.UncheckedCast<Float64T>(LoadHeapNumberValue_450(state_, compiler::TNode<HeapNumber>{ca_.UncheckedCast<HeapNumber>(tmp63)}));
    ca_.SetSourcePosition("../../src/builtins/string-substring.tq", 24);
    compiler::TNode<Float64T> tmp65;
    USE(tmp65);
    tmp65 = ca_.UncheckedCast<Float64T>(FromConstexpr9ATfloat6417ATconstexpr_int31_142(state_, 0.));
  ...
  if (block15.is_used()) {
    ...
    USE(tmp88);
    tmp88 = ca_.UncheckedCast<Smi>(FromConstexpr5ATSmi17ATconstexpr_int31_131(state_, 0));
...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ...
    USE(tmp5);
    tmp5 = ca_.UncheckedCast<String>(FromConstexpr6String18ATconstexpr_string_133(state_, "String.prototype.substring"));
    ...
    USE(tmp10);
    tmp10 = ca_.UncheckedCast<Smi>(ToSmiBetweenZeroAnd_289(state_, compiler::TNode<Context>{tmp0}, compiler::TNode<Object>{tmp9}, compiler::TNode<Smi>{tmp7}));
  ...
  if (block2.is_used()) {
    ...
    USE(tmp31);
    tmp31 = ca_.UncheckedCast<IntPtrT>(FromConstexpr8ATintptr17ATconstexpr_int31_127(state_, 1));
    compiler::TNode<Object> tmp32;
    USE(tmp32);
    tmp32 = ca_.UncheckedCast<Object>(CodeStubAssembler(state_).GetArgumentValue(TorqueStructArguments{compiler::TNode<RawPtrT>{tmp25}, compiler::TNode<RawPtrT>{tmp26}, compiler::TNode<IntPtrT>{tmp27}}, compiler::TNode<IntPtrT>{tmp31}));
    compiler::TNode<Smi> tmp33;
    USE(tmp33);
    tmp33 = ca_.UncheckedCast<Smi>(ToSmiBetweenZeroAnd_289(state_, compiler::TNode<Context>{tmp23}, compiler::TNode<Object>{tmp32}, compiler::TNode<Smi>{tmp29}));
    ca_.SetSourcePosition("../../src/builtins/string-substring.tq", 40);
