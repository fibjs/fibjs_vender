...
USE(parameter1);
  ...
  if (block13.is_used()) {
    ...
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp93 = FastArrayFind_5(state_, compiler::TNode<Context>{tmp84}, compiler::TNode<JSReceiver>{tmp89}, compiler::TNode<Number>{tmp90}, compiler::TNode<JSReceiver>{tmp91}, compiler::TNode<Object>{tmp92}, &label0, &result_0_0);
