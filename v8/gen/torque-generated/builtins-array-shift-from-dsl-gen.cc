...
compiler::TNode<Object> ArrayShiftBuiltinsFromDSLAssembler::TryFastArrayShift(compiler::TNode<Context> p_context, compiler::TNode<Object> p_receiver, BaseBuiltinsFromDSLAssembler::Arguments p_arguments, compiler::CodeAssemblerLabel* label_Slow) {
  ...
  if (block21.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/base.tq", 2184);
  ...
  if (block29.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/base.tq", 2242);
  ...
  if (block30.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/base.tq", 2246);
  ...
  if (block36.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/base.tq", 2246);
    ca_.SetSourcePosition("../../src/builtins/base.tq", 2248);
  ...
  if (block41.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/base.tq", 2251);
  ...
  if (block42.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/base.tq", 2245);
    ca_.SetSourcePosition("../../src/builtins/base.tq", 2240);
  ...
  if (block48.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/base.tq", 2192);
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block45.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/base.tq", 2195);
