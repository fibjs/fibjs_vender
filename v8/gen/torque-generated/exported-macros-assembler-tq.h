...
class V8_EXPORT_PRIVATE TorqueGeneratedExportedMacrosAssembler {
 public:
  ...
  compiler::TNode<String> LoadUncompiledDataInferredName(compiler::TNode<UncompiledData> p_o);
  void StoreUncompiledDataInferredName(compiler::TNode<UncompiledData> p_o, compiler::TNode<String> p_v);
  compiler::TNode<Int32T> LoadUncompiledDataStartPosition(compiler::TNode<UncompiledData> p_o);
  void StoreUncompiledDataStartPosition(compiler::TNode<UncompiledData> p_o, compiler::TNode<Int32T> p_v);
  compiler::TNode<Int32T> LoadUncompiledDataEndPosition(compiler::TNode<UncompiledData> p_o);
  void StoreUncompiledDataEndPosition(compiler::TNode<UncompiledData> p_o, compiler::TNode<Int32T> p_v);
  compiler::TNode<PreparseData> LoadUncompiledDataWithPreparseDataPreparseData(compiler::TNode<UncompiledDataWithPreparseData> p_o);
  void StoreUncompiledDataWithPreparseDataPreparseData(compiler::TNode<UncompiledDataWithPreparseData> p_o, compiler::TNode<PreparseData> p_v);
