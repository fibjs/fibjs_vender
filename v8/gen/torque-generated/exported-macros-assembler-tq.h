...
class V8_EXPORT_PRIVATE TorqueGeneratedExportedMacrosAssembler {
 public:
  ...
  compiler::TNode<Int16T> LoadMapInstanceType(compiler::TNode<Map> p_o);
  void StoreMapInstanceType(compiler::TNode<Map> p_o, compiler::TNode<Int16T> p_v);
  ...
  compiler::TNode<Object> LoadStackFrameInfoWasmModuleName(compiler::TNode<StackFrameInfo> p_o);
  void StoreStackFrameInfoWasmModuleName(compiler::TNode<StackFrameInfo> p_o, compiler::TNode<Object> p_v);
  ...
  compiler::TNode<Object> LoadJSIteratorResultValue(compiler::TNode<JSIteratorResult> p_o);
  void StoreJSIteratorResultValue(compiler::TNode<JSIteratorResult> p_o, compiler::TNode<Object> p_v);
  compiler::TNode<Oddball> LoadJSIteratorResultDone(compiler::TNode<JSIteratorResult> p_o);
  void StoreJSIteratorResultDone(compiler::TNode<JSIteratorResult> p_o, compiler::TNode<Oddball> p_v);
  ...
  compiler::TNode<BuiltinPtr> LoadSortStateDeleteFn(compiler::TNode<FixedArray> p_o);
  void StoreSortStateDeleteFn(compiler::TNode<FixedArray> p_o, compiler::TNode<BuiltinPtr> p_v);
  ...
  compiler::TNode<Smi> LoadSortStateSortLength(compiler::TNode<FixedArray> p_o);
  void StoreSortStateSortLength(compiler::TNode<FixedArray> p_o, compiler::TNode<Smi> p_v);
  compiler::TNode<Smi> LoadSortStateNumberOfUndefined(compiler::TNode<FixedArray> p_o);
  void StoreSortStateNumberOfUndefined(compiler::TNode<FixedArray> p_o, compiler::TNode<Smi> p_v);
 private:
