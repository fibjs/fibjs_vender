...
void TryFastArrayUnshift_50(compiler::CodeAssemblerState* state_, compiler::TNode<Context> p_context, compiler::TNode<Object> p_receiver, TorqueStructArguments p_arguments, compiler::CodeAssemblerLabel* label_Slow) {
  ...
  if (block2.is_used()) {
    ...
    EnsureWriteableFastElements_52(state_, compiler::TNode<Context>{tmp12}, compiler::TNode<JSArray>{tmp18});
  ...
  if (block6.is_used()) {
    ...
    USE(tmp53);
    tmp53 = ca_.UncheckedCast<JSFunction>(LoadTargetFromFrame_269(state_));
    compiler::TNode<Oddball> tmp54;
    USE(tmp54);
    tmp54 = Undefined_70(state_);
    ca_.SetSourcePosition("../../src/builtins/array-unshift.tq", 20);
    compiler::TNode<Int32T> tmp55;
    USE(tmp55);
    tmp55 = ca_.UncheckedCast<Int32T>(Convert7ATint328ATintptr_160(state_, compiler::TNode<IntPtrT>{tmp49}));
...
compiler::TNode<Number> GenericArrayUnshift_51(compiler::CodeAssemblerState* state_, compiler::TNode<Context> p_context, compiler::TNode<Object> p_receiver, TorqueStructArguments p_arguments) {
  ...
  if (block0.is_used()) {
    ...
    compiler::TNode<IntPtrT> tmp4;
    ca_.Bind(&block0, &tmp0, &tmp1, &tmp2, &tmp3, &tmp4);
    ca_.SetSourcePosition("../../src/builtins/array-unshift.tq", 26);
    ...
    ca_.SetSourcePosition("../../src/builtins/array-unshift.tq", 29);
    ...
    USE(tmp7);
    tmp7 = ca_.UncheckedCast<Smi>(Convert5ATSmi8ATintptr_161(state_, compiler::TNode<IntPtrT>{tmp4}));
    ca_.SetSourcePosition("../../src/builtins/array-unshift.tq", 35);
    compiler::TNode<Smi> tmp8;
    USE(tmp8);
    tmp8 = ca_.UncheckedCast<Smi>(FromConstexpr5ATSmi17ATconstexpr_int31_131(state_, 0));
  ...
  if (block2.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-unshift.tq", 37);
    ...
    USE(tmp19);
    tmp19 = ca_.UncheckedCast<Number>(FromConstexpr20UT5ATSmi10HeapNumber19ATconstexpr_float64_136(state_, kMaxSafeInteger));
    compiler::CodeAssemblerLabel label0(&ca_);
  ...
  if (block5.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-unshift.tq", 42);
    ca_.SetSourcePosition("../../src/builtins/array-unshift.tq", 45);
  ...
  if (block10.is_used()) {
    ...
    USE(tmp63);
    tmp63 = ca_.UncheckedCast<Number>(FromConstexpr20UT5ATSmi10HeapNumber17ATconstexpr_int31_137(state_, 0));
    compiler::CodeAssemblerLabel label0(&ca_);
    compiler::CodeAssemblerLabel label1(&ca_);
  ...
  if (block8.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-unshift.tq", 47);
    ...
    ca_.SetSourcePosition("../../src/builtins/array-unshift.tq", 50);
    ...
    USE(tmp96);
    tmp96 = ca_.UncheckedCast<Number>(FromConstexpr20UT5ATSmi10HeapNumber17ATconstexpr_int31_137(state_, 1));
    ...
    USE(tmp98);
    ca_.SetSourcePosition("../../src/builtins/array-unshift.tq", 56);
    compiler::TNode<Oddball> tmp99;
    USE(tmp99);
    tmp99 = True_71(state_);
  ...
  if (block13.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-unshift.tq", 58);
    ...
    ca_.SetSourcePosition("../../src/builtins/array-unshift.tq", 61);
  ...
  if (block14.is_used()) {
    ...
    USE(tmp127);
    tmp127 = ca_.UncheckedCast<Smi>(FromConstexpr14ATLanguageMode24ATconstexpr_LanguageMode_145(state_, LanguageMode::kStrict));
  ...
  if (block15.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-unshift.tq", 68);
    compiler::TNode<Number> tmp141;
    USE(tmp141);
    tmp141 = ca_.UncheckedCast<Number>(FromConstexpr20UT5ATSmi10HeapNumber17ATconstexpr_int31_137(state_, 1));
  ...
  if (block9.is_used()) {
    ...
    USE(tmp152);
    tmp152 = ca_.UncheckedCast<Smi>(FromConstexpr5ATSmi17ATconstexpr_int31_131(state_, 0));
    ca_.SetSourcePosition("../../src/builtins/array-unshift.tq", 77);
  ...
  if (block16.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-unshift.tq", 79);
    compiler::TNode<IntPtrT> tmp174;
    USE(tmp174);
    tmp174 = ca_.UncheckedCast<IntPtrT>(Convert8ATintptr5ATSmi_163(state_, compiler::TNode<Smi>{tmp173}));
    compiler::TNode<Object> tmp175;
    USE(tmp175);
    tmp175 = ca_.UncheckedCast<Object>(CodeStubAssembler(state_).GetArgumentValue(TorqueStructArguments{compiler::TNode<RawPtrT>{tmp166}, compiler::TNode<RawPtrT>{tmp167}, compiler::TNode<IntPtrT>{tmp168}}, compiler::TNode<IntPtrT>{tmp174}));
    CodeStubAssembler(state_).CallBuiltin(Builtins::kSetProperty, tmp164, tmp169, tmp173, tmp175);
    ca_.SetSourcePosition("../../src/builtins/array-unshift.tq", 82);
    compiler::TNode<Smi> tmp177;
    USE(tmp177);
    tmp177 = ca_.UncheckedCast<Smi>(FromConstexpr5ATSmi17ATconstexpr_int31_131(state_, 1));
  ...
  if (block3.is_used()) {
    ...
    USE(tmp198);
    tmp198 = kLengthString_74(state_);
...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ...
    compiler::TNode<IntPtrT> tmp4;
    ca_.Bind(&block0, &tmp0, &tmp1, &tmp2, &tmp3, &tmp4);
    ca_.SetSourcePosition("../../src/builtins/array-unshift.tq", 98);
    compiler::CodeAssemblerLabel label0(&ca_);
    TryFastArrayUnshift_50(state_, compiler::TNode<Context>{tmp0}, compiler::TNode<Object>{tmp1}, TorqueStructArguments{compiler::TNode<RawPtrT>{tmp2}, compiler::TNode<RawPtrT>{tmp3}, compiler::TNode<IntPtrT>{tmp4}}, &label0);
    if (label0.is_used()) {
      ca_.Bind(&label0);
  ...
  if (block2.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-unshift.tq", 101);
    compiler::TNode<Number> tmp20;
    USE(tmp20);
    tmp20 = ca_.UncheckedCast<Number>(GenericArrayUnshift_51(state_, compiler::TNode<Context>{tmp15}, compiler::TNode<Object>{tmp16}, TorqueStructArguments{compiler::TNode<RawPtrT>{tmp17}, compiler::TNode<RawPtrT>{tmp18}, compiler::TNode<IntPtrT>{tmp19}}));
