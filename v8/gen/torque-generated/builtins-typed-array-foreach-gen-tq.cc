...
const char* kBuiltinName_306(compiler::CodeAssemblerState* state_) {
...
compiler::TNode<Object> ForEachAllElements_307(compiler::CodeAssemblerState* state_, compiler::TNode<Context> p_context, compiler::TNode<JSTypedArray> p_array, compiler::TNode<JSReceiver> p_callbackfn, compiler::TNode<Object> p_thisArg) {
  compiler::CodeAssembler ca_(state_);
  ...
  if (block10.is_used()) {
    ...
    USE(tmp160);
    tmp160 = ca_.UncheckedCast<Smi>(FromConstexpr5ATSmi17ATconstexpr_int31_131(state_, 1));
    compiler::TNode<Smi> tmp161;
    USE(tmp161);
    tmp161 = ca_.UncheckedCast<Smi>(CodeStubAssembler(state_).SmiAdd(compiler::TNode<Smi>{tmp159}, compiler::TNode<Smi>{tmp160}));
...
USE(parameter1);
  ...
  if (block11.is_used()) {
    ...
    USE(tmp57);
    tmp57 = ca_.UncheckedCast<Object>(ForEachAllElements_307(state_, compiler::TNode<Context>{tmp46}, compiler::TNode<JSTypedArray>{tmp52}, compiler::TNode<JSReceiver>{tmp54}, compiler::TNode<Object>{tmp56}));
  ...
  if (block4.is_used()) {
    ...
    CodeStubAssembler(state_).ThrowTypeError(compiler::TNode<Context>{tmp65}, MessageTemplate::kNotTypedArray, kBuiltinName_306(state_));
  }
  ...
  if (block2.is_used()) {
    ...
    CodeStubAssembler(state_).ThrowTypeError(compiler::TNode<Context>{tmp70}, MessageTemplate::kDetachedOperation, kBuiltinName_306(state_));
  }
}
