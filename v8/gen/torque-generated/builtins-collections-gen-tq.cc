...
TorqueStructKeyValuePair LoadKeyValuePairNoSideEffects_229(compiler::CodeAssemblerState* state_, compiler::TNode<Context> p_context, compiler::TNode<Object> p_o, compiler::CodeAssemblerLabel* label_MayHaveSideEffects) {
  ...
  if (block5.is_used()) {
    ...
    USE(tmp15);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp15 = Cast10FixedArray_89(state_, compiler::TNode<HeapObject>{tmp14}, &label0);
  ...
  if (block11.is_used()) {
    ...
    USE(tmp41);
    tmp41 = ca_.UncheckedCast<Object>(LoadElementOrUndefined_54(state_, compiler::TNode<FixedArray>{tmp39}, compiler::TNode<Smi>{tmp40}));
  ...
  if (block13.is_used()) {
    ...
    USE(tmp66);
    tmp66 = ca_.UncheckedCast<Smi>(FromConstexpr5ATSmi17ATconstexpr_int31_131(state_, 1));
  ...
  if (block15.is_used()) {
    ...
    USE(tmp77);
    tmp77 = ca_.UncheckedCast<Object>(LoadElementOrUndefined_54(state_, compiler::TNode<FixedArray>{tmp74}, compiler::TNode<Smi>{tmp76}));
  ...
  if (block8.is_used()) {
    ...
    USE(tmp111);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp111 = Cast16FixedDoubleArray_90(state_, compiler::TNode<HeapObject>{ca_.UncheckedCast<FixedArrayBase>(tmp110)}, &label0);
  ...
  if (block21.is_used()) {
    ...
    USE(tmp127);
    tmp127 = ca_.UncheckedCast<Smi>(FromConstexpr5ATSmi17ATconstexpr_int31_131(state_, 0));
  ...
  if (block23.is_used()) {
    ...
    USE(tmp136);
    tmp136 = ca_.UncheckedCast<Smi>(FromConstexpr5ATSmi17ATconstexpr_int31_131(state_, 0));
    compiler::TNode<Object> tmp137;
    USE(tmp137);
    tmp137 = ca_.UncheckedCast<Object>(LoadElementOrUndefined_55(state_, compiler::TNode<FixedDoubleArray>{tmp135}, compiler::TNode<Smi>{tmp136}));
  ...
  if (block25.is_used()) {
    ...
    USE(tmp162);
    tmp162 = ca_.UncheckedCast<Smi>(FromConstexpr5ATSmi17ATconstexpr_int31_131(state_, 1));
  ...
  if (block27.is_used()) {
    ...
    USE(tmp173);
    tmp173 = ca_.UncheckedCast<Object>(LoadElementOrUndefined_55(state_, compiler::TNode<FixedDoubleArray>{tmp170}, compiler::TNode<Smi>{tmp172}));
  ...
  if (block4.is_used()) {
    ...
    USE(tmp210);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp210 = Cast10JSReceiver_1170(state_, compiler::TNode<Context>{tmp207}, compiler::TNode<Object>{ca_.UncheckedCast<Object>(tmp209)}, &label0);
...
TorqueStructKeyValuePair LoadKeyValuePair_230(compiler::CodeAssemblerState* state_, compiler::TNode<Context> p_context, compiler::TNode<Object> p_o) {
  ...
  if (block0.is_used()) {
    ...
    USE(tmp3);
    compiler::CodeAssemblerLabel label0(&ca_);
    std::tie(tmp2, tmp3) = LoadKeyValuePairNoSideEffects_229(state_, compiler::TNode<Context>{tmp0}, compiler::TNode<Object>{tmp1}, &label0).Flatten();
  ...
  if (block3.is_used()) {
    ...
    USE(tmp16);
    tmp16 = ca_.UncheckedCast<Smi>(Convert5ATSmi17ATconstexpr_int31_1172(state_, 1));
    compiler::TNode<Object> tmp17;
    USE(tmp17);
