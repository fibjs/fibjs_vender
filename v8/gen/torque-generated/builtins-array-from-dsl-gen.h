...
class ArrayBuiltinsFromDSLAssembler {
 public:
  ...
  compiler::TNode<BuiltinPtr> UnsafeCast50FT9ATContext9SortState5ATSmi20UT5ATSmi10HeapObject(compiler::TNode<Context> p_context, compiler::TNode<Object> p_o);
  compiler::TNode<BuiltinPtr> UnsafeCast56FT9ATContext9SortState5ATSmi20UT5ATSmi10HeapObject5ATSmi(compiler::TNode<Context> p_context, compiler::TNode<Object> p_o);
  ...
  void CopyElement(compiler::TNode<Context> p_context, compiler::TNode<FixedArray> p_sortState, compiler::TNode<BuiltinPtr> p_load, compiler::TNode<BuiltinPtr> p_store, compiler::TNode<Smi> p_from, compiler::TNode<Smi> p_to, compiler::CodeAssemblerLabel* label_Bailout);
  ...
  void CopyReceiverElementsToWorkArray(compiler::TNode<Context> p_context, compiler::TNode<FixedArray> p_sortState, compiler::TNode<Smi> p_length, compiler::CodeAssemblerLabel* label_Bailout);
  void CopyWorkArrayToReceiver(compiler::TNode<Context> p_context, compiler::TNode<FixedArray> p_sortState, compiler::TNode<Smi> p_length, compiler::CodeAssemblerLabel* label_Bailout);
  ...
  compiler::TNode<Smi> LoadSortStateAccessor(compiler::TNode<FixedArray> p_o);
  void StoreSortStateAccessor(compiler::TNode<FixedArray> p_o, compiler::TNode<Smi> p_v);
