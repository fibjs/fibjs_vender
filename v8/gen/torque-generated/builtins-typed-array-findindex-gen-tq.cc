...
compiler::TNode<Number> FindIndexAllElements_305(compiler::CodeAssemblerState* state_, compiler::TNode<Context> p_context, compiler::TNode<JSTypedArray> p_array, compiler::TNode<JSReceiver> p_callbackfn, compiler::TNode<Object> p_thisArg) {
  ...
  if (block8.is_used()) {
    ...
    USE(tmp194);
    tmp194 = ca_.UncheckedCast<Number>(FromConstexpr20UT5ATSmi10HeapNumber17ATconstexpr_int31_137(state_, -1));
...
USE(parameter1);
  ...
  if (block11.is_used()) {
    ...
    USE(tmp57);
    tmp57 = ca_.UncheckedCast<Number>(FindIndexAllElements_305(state_, compiler::TNode<Context>{tmp46}, compiler::TNode<JSTypedArray>{tmp52}, compiler::TNode<JSReceiver>{tmp54}, compiler::TNode<Object>{tmp56}));
  ...
  if (block4.is_used()) {
    ...
    CodeStubAssembler(state_).ThrowTypeError(compiler::TNode<Context>{tmp65}, MessageTemplate::kNotTypedArray, kBuiltinName_304(state_));
  }
  ...
  if (block2.is_used()) {
    ...
    CodeStubAssembler(state_).ThrowTypeError(compiler::TNode<Context>{tmp70}, MessageTemplate::kDetachedOperation, kBuiltinName_304(state_));
  }
}
