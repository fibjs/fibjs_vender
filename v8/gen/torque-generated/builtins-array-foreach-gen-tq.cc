...
TF_BUILTIN(ArrayForEachLoopLazyDeoptContinuation, CodeStubAssembler) {
  ...
  if (block5.is_used()) {
    ...
    USE(tmp77);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp77 = Cast20UT5ATSmi10HeapNumber_86(state_, compiler::TNode<Object>{tmp72}, &label0);
...
compiler::TNode<Object> FastArrayForEach_7(compiler::CodeAssemblerState* state_, compiler::TNode<Context> p_context, compiler::TNode<JSReceiver> p_o, compiler::TNode<Number> p_len, compiler::TNode<JSReceiver> p_callbackfn, compiler::TNode<Object> p_thisArg, compiler::CodeAssemblerLabel* label_Bailout, compiler::TypedCodeAssemblerVariable<Smi>* label_Bailout_parameter_0) {
  ...
  if (block28.is_used()) {
    ...
    USE(tmp269);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp269 = LoadElementNoHole16FixedDoubleArray_214(state_, compiler::TNode<Context>{tmp267}, compiler::TNode<JSArray>{tmp261}, compiler::TNode<Smi>{tmp268}, &label0);
  ...
  if (block29.is_used()) {
    ...
    USE(tmp326);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp326 = LoadElementNoHole10FixedArray_213(state_, compiler::TNode<Context>{tmp324}, compiler::TNode<JSArray>{tmp318}, compiler::TNode<Smi>{tmp325}, &label0);
  ...
  if (block14.is_used()) {
    ...
    USE(tmp449);
    tmp449 = ca_.UncheckedCast<Smi>(FromConstexpr5ATSmi17ATconstexpr_int31_131(state_, 1));
...
USE(parameter1);
  ...
  if (block13.is_used()) {
    ...
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp94 = FastArrayForEach_7(state_, compiler::TNode<Context>{tmp84}, compiler::TNode<JSReceiver>{tmp89}, compiler::TNode<Number>{tmp90}, compiler::TNode<JSReceiver>{tmp91}, compiler::TNode<Object>{tmp92}, &label0, &result_0_0);
  ...
  if (block4.is_used()) {
    ...
    USE(tmp155);
    tmp155 = ca_.UncheckedCast<IntPtrT>(FromConstexpr8ATintptr17ATconstexpr_int31_127(state_, 0));
    compiler::TNode<Object> tmp156;
    USE(tmp156);
    tmp156 = ca_.UncheckedCast<Object>(CodeStubAssembler(state_).GetArgumentValue(TorqueStructArguments{compiler::TNode<RawPtrT>{tmp152}, compiler::TNode<RawPtrT>{tmp153}, compiler::TNode<IntPtrT>{tmp154}}, compiler::TNode<IntPtrT>{tmp155}));
