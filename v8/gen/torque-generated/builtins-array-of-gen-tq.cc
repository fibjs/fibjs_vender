...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ...
    USE(tmp5);
    tmp5 = ca_.UncheckedCast<Smi>(Convert5ATSmi8ATintptr_161(state_, compiler::TNode<IntPtrT>{tmp4}));
    ...
    tmp6 = Cast13ATConstructor_1189(state_, compiler::TNode<Context>{tmp0}, compiler::TNode<Object>{tmp1}, &label0);
  ...
  if (block5.is_used()) {
    ...
    USE(tmp86);
    tmp86 = ca_.UncheckedCast<IntPtrT>(Convert8ATintptr5ATSmi_163(state_, compiler::TNode<Smi>{tmp85}));
    compiler::TNode<Object> tmp87;
    USE(tmp87);
    tmp87 = ca_.UncheckedCast<Object>(CodeStubAssembler(state_).GetArgumentValue(TorqueStructArguments{compiler::TNode<RawPtrT>{tmp80}, compiler::TNode<RawPtrT>{tmp81}, compiler::TNode<IntPtrT>{tmp82}}, compiler::TNode<IntPtrT>{tmp86}));
    ...
    USE(tmp89);
    tmp89 = ca_.UncheckedCast<Smi>(FromConstexpr5ATSmi17ATconstexpr_int31_131(state_, 1));
