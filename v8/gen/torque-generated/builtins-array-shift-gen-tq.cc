...
compiler::TNode<Object> TryFastArrayShift_37(compiler::CodeAssemblerState* state_, compiler::TNode<Context> p_context, compiler::TNode<Object> p_receiver, TorqueStructArguments p_arguments, compiler::CodeAssemblerLabel* label_Slow) {
  ...
  if (block0.is_used()) {
    ...
    tmp5 = Cast13ATFastJSArray_1188(state_, compiler::TNode<Context>{tmp0}, compiler::TNode<Object>{tmp1}, &label0);
  ...
  if (block3.is_used()) {
    ...
    USE(tmp24);
    std::tie(tmp19, tmp20, tmp21, tmp22, tmp23, tmp24) = NewFastJSArrayWitness_215(state_, compiler::TNode<JSArray>{tmp18}).Flatten();
    ca_.SetSourcePosition("../../src/builtins/array-shift.tq", 14);
    ca_.SetSourcePosition("../../src/builtins/base.tq", 2616);
  ...
  if (block6.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/base.tq", 2617);
    EnsureWriteableFastElements_52(state_, compiler::TNode<Context>{tmp52}, compiler::TNode<JSArray>{tmp47});
    ca_.SetSourcePosition("../../src/builtins/base.tq", 2618);
    compiler::TNode<BoolT> tmp55;
    USE(tmp55);
    tmp55 = ca_.UncheckedCast<BoolT>(FromConstexpr6ATbool16ATconstexpr_bool_144(state_, true));
    ca_.SetSourcePosition("../../src/builtins/array-shift.tq", 14);
  ...
  if (block5.is_used()) {
    ...
    USE(tmp70);
    tmp70 = ca_.UncheckedCast<Smi>(FromConstexpr5ATSmi17ATconstexpr_int31_131(state_, 0));
  ...
  if (block9.is_used()) {
    ...
    USE(tmp98);
    tmp98 = ca_.UncheckedCast<Smi>(FromConstexpr5ATSmi17ATconstexpr_int31_131(state_, 1));
    ...
    USE(tmp101);
    tmp101 = ca_.UncheckedCast<Smi>(FromConstexpr5ATSmi17ATconstexpr_int31_131(state_, JSObject::kMinAddedElementsCapacity));
  ...
  if (block13.is_used()) {
    ...
    USE(tmp134);
    tmp134 = ca_.UncheckedCast<Smi>(FromConstexpr5ATSmi17ATconstexpr_int31_131(state_, JSArray::kMaxCopyElements));
  ...
  if (block15.is_used()) {
    ...
    USE(tmp162);
    tmp162 = ca_.UncheckedCast<Smi>(FromConstexpr5ATSmi17ATconstexpr_int31_131(state_, 0));
    ca_.SetSourcePosition("../../src/builtins/base.tq", 2608);
  ...
  if (block20.is_used()) {
    ...
    USE(tmp181);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp181 = LoadElementNoHole16FixedDoubleArray_214(state_, compiler::TNode<Context>{tmp179}, compiler::TNode<JSArray>{tmp170}, compiler::TNode<Smi>{tmp180}, &label0);
  ...
  if (block21.is_used()) {
    ...
    USE(tmp241);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp241 = LoadElementNoHole10FixedArray_213(state_, compiler::TNode<Context>{tmp239}, compiler::TNode<JSArray>{tmp230}, compiler::TNode<Smi>{tmp240}, &label0);
  ...
  if (block18.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/base.tq", 2611);
    compiler::TNode<Oddball> tmp317;
    USE(tmp317);
    tmp317 = Undefined_70(state_);
  ...
  if (block16.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/base.tq", 2623);
    StoreFastJSArrayLength_191(state_, compiler::TNode<JSArray>{tmp325}, compiler::TNode<Smi>{tmp330});
    ca_.SetSourcePosition("../../src/builtins/array-shift.tq", 35);
  ...
  if (block27.is_used()) {
    ...
    USE(tmp350);
    tmp350 = ca_.UncheckedCast<IntPtrT>(Convert8ATintptr5ATSmi_163(state_, compiler::TNode<Smi>{tmp346}));
    compiler::TNode<IntPtrT> tmp351;
    USE(tmp351);
    tmp351 = ca_.UncheckedCast<IntPtrT>(FromConstexpr8ATintptr17ATconstexpr_int31_127(state_, 0));
    compiler::TNode<IntPtrT> tmp352;
    USE(tmp352);
    tmp352 = ca_.UncheckedCast<IntPtrT>(FromConstexpr8ATintptr17ATconstexpr_int31_127(state_, 1));
    ca_.SetSourcePosition("../../src/builtins/base.tq", 2645);
  ...
  if (block29.is_used()) {
    ...
    USE(tmp373);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp373 = Cast16FixedDoubleArray_90(state_, compiler::TNode<HeapObject>{tmp372}, &label0);
  ...
  if (block33.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/base.tq", 2648);
  ...
  if (block32.is_used()) {
    ...
    TorqueMoveElements_210(state_, compiler::TNode<FixedDoubleArray>{tmp449}, compiler::TNode<IntPtrT>{tmp446}, compiler::TNode<IntPtrT>{tmp447}, compiler::TNode<IntPtrT>{tmp448});
    ca_.SetSourcePosition("../../src/builtins/base.tq", 2645);
  ...
  if (block30.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/base.tq", 2651);
    ...
    USE(tmp470);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp470 = Cast10FixedArray_89(state_, compiler::TNode<HeapObject>{tmp469}, &label0);
  ...
  if (block40.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/base.tq", 2654);
    TorqueMoveElementsSmi_208(state_, compiler::TNode<FixedArray>{tmp565}, compiler::TNode<IntPtrT>{tmp562}, compiler::TNode<IntPtrT>{tmp563}, compiler::TNode<IntPtrT>{tmp564});
    ca_.SetSourcePosition("../../src/builtins/base.tq", 2653);
  ...
  if (block41.is_used()) {
    ...
    TorqueMoveElements_209(state_, compiler::TNode<FixedArray>{tmp584}, compiler::TNode<IntPtrT>{tmp581}, compiler::TNode<IntPtrT>{tmp582}, compiler::TNode<IntPtrT>{tmp583});
    ca_.SetSourcePosition("../../src/builtins/base.tq", 2653);
  ...
  if (block28.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/base.tq", 2595);
  ...
  if (block44.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/base.tq", 2596);
    ...
    USE(tmp658);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp658 = Cast16FixedDoubleArray_90(state_, compiler::TNode<HeapObject>{tmp657}, &label0);
  ...
  if (block48.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/base.tq", 2597);
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block47.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/base.tq", 2598);
  ...
  if (block45.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/base.tq", 2600);
    ...
    USE(tmp745);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp745 = Cast10FixedArray_89(state_, compiler::TNode<HeapObject>{tmp744}, &label0);
  ...
  if (block52.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/base.tq", 2601);
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block51.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/base.tq", 2602);
    compiler::TNode<Oddball> tmp814;
    USE(tmp814);
    tmp814 = Hole_68(state_);
    ...
    ca_.SetSourcePosition("../../src/builtins/base.tq", 2599);
    ca_.SetSourcePosition("../../src/builtins/base.tq", 2595);
  ...
  if (block43.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-shift.tq", 38);
  ...
  if (block11.is_used()) {
    ...
    USE(tmp859);
    tmp859 = ca_.UncheckedCast<JSFunction>(LoadTargetFromFrame_269(state_));
    compiler::TNode<Oddball> tmp860;
    USE(tmp860);
    tmp860 = Undefined_70(state_);
    ca_.SetSourcePosition("../../src/builtins/array-shift.tq", 43);
    compiler::TNode<Int32T> tmp861;
    USE(tmp861);
    tmp861 = ca_.UncheckedCast<Int32T>(Convert7ATint328ATintptr_160(state_, compiler::TNode<IntPtrT>{tmp851}));
...
compiler::TNode<Object> GenericArrayShift_38(compiler::CodeAssemblerState* state_, compiler::TNode<Context> p_context, compiler::TNode<Object> p_receiver) {
  ...
  if (block0.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-shift.tq", 53);
    compiler::TNode<Number> tmp3;
    USE(tmp3);
    tmp3 = ca_.UncheckedCast<Number>(GetLengthProperty_219(state_, compiler::TNode<Context>{tmp0}, compiler::TNode<Object>{tmp2}));
    ca_.SetSourcePosition("../../src/builtins/array-shift.tq", 56);
    compiler::TNode<Number> tmp4;
    USE(tmp4);
    tmp4 = ca_.UncheckedCast<Number>(FromConstexpr20UT5ATSmi10HeapNumber17ATconstexpr_int31_137(state_, 0));
    compiler::TNode<BoolT> tmp5;
    USE(tmp5);
    tmp5 = ca_.UncheckedCast<BoolT>(IsNumberEqual_79(state_, compiler::TNode<Number>{tmp3}, compiler::TNode<Number>{tmp4}));
  ...
  if (block2.is_used()) {
    ...
    USE(tmp10);
    tmp10 = kLengthString_74(state_);
    compiler::TNode<Smi> tmp11;
    USE(tmp11);
    tmp11 = ca_.UncheckedCast<Smi>(Convert5ATSmi17ATconstexpr_int31_1172(state_, 0));
  ...
  if (block3.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-shift.tq", 64);
    compiler::TNode<Smi> tmp18;
    USE(tmp18);
    tmp18 = ca_.UncheckedCast<Smi>(Convert5ATSmi17ATconstexpr_int31_1172(state_, 0));
    ...
    ca_.SetSourcePosition("../../src/builtins/array-shift.tq", 66);
    compiler::TNode<Number> tmp20;
    USE(tmp20);
    tmp20 = ca_.UncheckedCast<Number>(FromConstexpr20UT5ATSmi10HeapNumber17ATconstexpr_int31_137(state_, 1));
  ...
  if (block4.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-shift.tq", 70);
    ca_.SetSourcePosition("../../src/builtins/array-shift.tq", 73);
    compiler::TNode<Number> tmp49;
    USE(tmp49);
    tmp49 = ca_.UncheckedCast<Number>(FromConstexpr20UT5ATSmi10HeapNumber17ATconstexpr_int31_137(state_, 1));
  ...
  if (block9.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-shift.tq", 81);
    ...
    ca_.SetSourcePosition("../../src/builtins/array-shift.tq", 84);
  ...
  if (block10.is_used()) {
    ...
    USE(tmp74);
    tmp74 = ca_.UncheckedCast<Smi>(FromConstexpr14ATLanguageMode24ATconstexpr_LanguageMode_145(state_, LanguageMode::kStrict));
  ...
  if (block11.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-shift.tq", 91);
    compiler::TNode<Number> tmp85;
    USE(tmp85);
    tmp85 = ca_.UncheckedCast<Number>(FromConstexpr20UT5ATSmi10HeapNumber17ATconstexpr_int31_137(state_, 1));
  ...
  if (block5.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-shift.tq", 95);
    compiler::TNode<Number> tmp93;
    USE(tmp93);
    tmp93 = ca_.UncheckedCast<Number>(FromConstexpr20UT5ATSmi10HeapNumber17ATconstexpr_int31_137(state_, 1));
    ...
    USE(tmp95);
    tmp95 = ca_.UncheckedCast<Smi>(FromConstexpr14ATLanguageMode24ATconstexpr_LanguageMode_145(state_, LanguageMode::kStrict));
    CodeStubAssembler(state_).CallBuiltin(Builtins::kDeleteProperty, tmp87, tmp89, tmp94, tmp95);
    ca_.SetSourcePosition("../../src/builtins/array-shift.tq", 98);
    compiler::TNode<String> tmp97;
    USE(tmp97);
    tmp97 = kLengthString_74(state_);
    compiler::TNode<Number> tmp98;
    USE(tmp98);
    tmp98 = ca_.UncheckedCast<Number>(FromConstexpr20UT5ATSmi10HeapNumber17ATconstexpr_int31_137(state_, 1));
    ...
    ca_.SetSourcePosition("../../src/builtins/array-shift.tq", 101);
  ...
  if (block1.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-shift.tq", 47);
...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ...
    USE(tmp5);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp5 = TryFastArrayShift_37(state_, compiler::TNode<Context>{tmp0}, compiler::TNode<Object>{tmp1}, TorqueStructArguments{compiler::TNode<RawPtrT>{tmp2}, compiler::TNode<RawPtrT>{tmp3}, compiler::TNode<IntPtrT>{tmp4}}, &label0);
  ...
  if (block2.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-shift.tq", 111);
    compiler::TNode<Object> tmp30;
    USE(tmp30);
    tmp30 = ca_.UncheckedCast<Object>(GenericArrayShift_38(state_, compiler::TNode<Context>{tmp25}, compiler::TNode<Object>{tmp26}));
