...
TF_BUILTIN(ArrayFindIndexLoopEagerDeoptContinuation, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    tmp6 = Cast10JSReceiver_1170(state_, compiler::TNode<Context>{tmp0}, compiler::TNode<Object>{tmp1}, &label0);
  ...
  if (block1.is_used()) {
    ...
    USE(tmp35);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp35 = Cast39UT15JSBoundFunction10JSFunction7JSProxy_1171(state_, compiler::TNode<Context>{tmp28}, compiler::TNode<Object>{tmp30}, &label0);
  ...
  if (block5.is_used()) {
    ...
    USE(tmp68);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp68 = Cast20UT5ATSmi10HeapNumber_86(state_, compiler::TNode<Object>{tmp64}, &label0);
  ...
  if (block9.is_used()) {
    ...
    USE(tmp105);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp105 = Cast20UT5ATSmi10HeapNumber_86(state_, compiler::TNode<Object>{tmp101}, &label0);
...
TF_BUILTIN(ArrayFindIndexLoopAfterCallbackLazyDeoptContinuation, CodeStubAssembler) {
  ...
  if (block5.is_used()) {
    ...
    USE(tmp86);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp86 = Cast20UT5ATSmi10HeapNumber_86(state_, compiler::TNode<Object>{tmp80}, &label0);
  ...
  if (block13.is_used()) {
    ...
    USE(tmp180);
    tmp180 = ca_.UncheckedCast<BoolT>(ToBoolean_217(state_, compiler::TNode<Object>{tmp175}));
...
TF_BUILTIN(ArrayFindIndexLoopContinuation, CodeStubAssembler) {
  ...
  if (block1.is_used()) {
    ...
    USE(tmp45);
    tmp45 = ca_.UncheckedCast<BoolT>(ToBoolean_217(state_, compiler::TNode<Object>{tmp44}));
  ...
  if (block4.is_used()) {
    ...
    USE(tmp74);
    tmp74 = ca_.UncheckedCast<Number>(FromConstexpr20UT5ATSmi10HeapNumber17ATconstexpr_int31_137(state_, 1));
  ...
  if (block2.is_used()) {
    ...
    USE(tmp84);
    tmp84 = ca_.UncheckedCast<Smi>(Convert5ATSmi17ATconstexpr_int31_1172(state_, -1));
...
compiler::TNode<Number> FastArrayFindIndex_6(compiler::CodeAssemblerState* state_, compiler::TNode<Context> p_context, compiler::TNode<JSReceiver> p_o, compiler::TNode<Number> p_len, compiler::TNode<JSReceiver> p_callbackfn, compiler::TNode<Object> p_thisArg, compiler::CodeAssemblerLabel* label_Bailout, compiler::TypedCodeAssemblerVariable<Smi>* label_Bailout_parameter_0) {
  ...
  if (block0.is_used()) {
    ...
    USE(tmp6);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp6 = Cast5ATSmi_84(state_, compiler::TNode<Object>{tmp2}, &label0);
  ...
  if (block3.is_used()) {
    ...
    USE(tmp35);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp35 = Cast13ATFastJSArray_115(state_, compiler::TNode<Context>{tmp28}, compiler::TNode<HeapObject>{tmp29}, &label0);
  ...
  if (block7.is_used()) {
    ...
    USE(tmp73);
    std::tie(tmp68, tmp69, tmp70, tmp71, tmp72, tmp73) = NewFastJSArrayWitness_215(state_, compiler::TNode<JSArray>{tmp67}).Flatten();
  ...
  if (block29.is_used()) {
    ...
    USE(tmp272);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp272 = LoadElementNoHole16FixedDoubleArray_214(state_, compiler::TNode<Context>{tmp270}, compiler::TNode<JSArray>{tmp261}, compiler::TNode<Smi>{tmp271}, &label0);
  ...
  if (block30.is_used()) {
    ...
    USE(tmp338);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp338 = LoadElementNoHole10FixedArray_213(state_, compiler::TNode<Context>{tmp336}, compiler::TNode<JSArray>{tmp327}, compiler::TNode<Smi>{tmp337}, &label0);
  ...
  if (block36.is_used()) {
    ...
    USE(tmp463);
    tmp463 = ca_.UncheckedCast<BoolT>(ToBoolean_217(state_, compiler::TNode<Object>{tmp462}));
  ...
  if (block14.is_used()) {
    ...
    USE(tmp510);
    tmp510 = ca_.UncheckedCast<Smi>(FromConstexpr5ATSmi17ATconstexpr_int31_131(state_, 1));
  ...
  if (block12.is_used()) {
    ...
    USE(tmp526);
    tmp526 = ca_.UncheckedCast<Number>(FromConstexpr20UT5ATSmi10HeapNumber17ATconstexpr_int31_137(state_, -1));
...
USE(parameter1);
  ...
  if (block13.is_used()) {
    ...
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp93 = FastArrayFindIndex_6(state_, compiler::TNode<Context>{tmp84}, compiler::TNode<JSReceiver>{tmp89}, compiler::TNode<Number>{tmp90}, compiler::TNode<JSReceiver>{tmp91}, compiler::TNode<Object>{tmp92}, &label0, &result_0_0);
  ...
  if (block4.is_used()) {
    ...
    USE(tmp138);
    tmp138 = ca_.UncheckedCast<IntPtrT>(FromConstexpr8ATintptr17ATconstexpr_int31_127(state_, 0));
    compiler::TNode<Object> tmp139;
    USE(tmp139);
    tmp139 = ca_.UncheckedCast<Object>(CodeStubAssembler(state_).GetArgumentValue(TorqueStructArguments{compiler::TNode<RawPtrT>{tmp135}, compiler::TNode<RawPtrT>{tmp136}, compiler::TNode<IntPtrT>{tmp137}}, compiler::TNode<IntPtrT>{tmp138}));
