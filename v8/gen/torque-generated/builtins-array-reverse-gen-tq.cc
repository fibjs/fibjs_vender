...
compiler::TNode<Smi> LoadElement23ATFastPackedSmiElements5ATSmi_29(compiler::CodeAssemblerState* state_, compiler::TNode<Context> p_context, compiler::TNode<FixedArrayBase> p_elements, compiler::TNode<Smi> p_index) {
  ...
  if (block0.is_used()) {
    ...
    USE(tmp5);
    tmp5 = ca_.UncheckedCast<Smi>(UnsafeCast5ATSmi_1176(state_, compiler::TNode<Context>{tmp0}, compiler::TNode<Object>{tmp4}));
...
void StoreElement23ATFastPackedSmiElements5ATSmi_32(compiler::CodeAssemblerState* state_, compiler::TNode<Context> p_context, compiler::TNode<FixedArrayBase> p_elements, compiler::TNode<Smi> p_index, compiler::TNode<Smi> p_value) {
  ...
  if (block0.is_used()) {
    ...
    USE(tmp4);
    tmp4 = ca_.UncheckedCast<FixedArray>(UnsafeCast10FixedArray_1175(state_, compiler::TNode<Context>{tmp0}, compiler::TNode<Object>{tmp1}));
...
void StoreElement26ATFastPackedDoubleElements9ATfloat64_34(compiler::CodeAssemblerState* state_, compiler::TNode<Context> p_context, compiler::TNode<FixedArrayBase> p_elements, compiler::TNode<Smi> p_index, compiler::TNode<Float64T> p_value) {
  ...
  if (block0.is_used()) {
    ...
    USE(tmp4);
    tmp4 = ca_.UncheckedCast<FixedDoubleArray>(UnsafeCast16FixedDoubleArray_1177(state_, compiler::TNode<Context>{tmp0}, compiler::TNode<Object>{tmp1}));
...
compiler::TNode<Object> GenericArrayReverse_35(compiler::CodeAssemblerState* state_, compiler::TNode<Context> p_context, compiler::TNode<Object> p_receiver) {
  ...
  if (block0.is_used()) {
    ...
    USE(tmp5);
    tmp5 = ca_.UncheckedCast<Number>(FromConstexpr20UT5ATSmi10HeapNumber17ATconstexpr_int31_137(state_, 1));
  ...
  if (block15.is_used()) {
    ...
    USE(tmp144);
    tmp144 = ca_.UncheckedCast<Smi>(FromConstexpr14ATLanguageMode24ATconstexpr_LanguageMode_145(state_, LanguageMode::kStrict));
  ...
  if (block19.is_used()) {
    ...
    USE(tmp180);
    tmp180 = ca_.UncheckedCast<Smi>(FromConstexpr14ATLanguageMode24ATconstexpr_LanguageMode_145(state_, LanguageMode::kStrict));
  ...
  if (block14.is_used()) {
    ...
    USE(tmp213);
    tmp213 = ca_.UncheckedCast<Number>(FromConstexpr20UT5ATSmi10HeapNumber17ATconstexpr_int31_137(state_, 1));
    ...
    USE(tmp215);
    tmp215 = ca_.UncheckedCast<Number>(FromConstexpr20UT5ATSmi10HeapNumber17ATconstexpr_int31_137(state_, 1));
...
void TryFastPackedArrayReverse_36(compiler::CodeAssemblerState* state_, compiler::TNode<Context> p_context, compiler::TNode<Object> p_receiver, compiler::CodeAssemblerLabel* label_Slow) {
  ...
  if (block3.is_used()) {
    ...
    USE(tmp13);
    tmp13 = ca_.UncheckedCast<Int32T>(FromConstexpr14ATElementsKind24ATconstexpr_ElementsKind_146(state_, PACKED_SMI_ELEMENTS));
  ...
  if (block5.is_used()) {
    ...
    EnsureWriteableFastElements_52(state_, compiler::TNode<Context>{tmp15}, compiler::TNode<JSArray>{tmp17});
    ...
    FastPackedArrayReverse23ATFastPackedSmiElements5ATSmi_1190(state_, compiler::TNode<Context>{tmp15}, compiler::TNode<FixedArrayBase>{tmp20}, compiler::TNode<Smi>{tmp21});
    ca_.SetSourcePosition("../../src/builtins/array-reverse.tq", 150);
  ...
  if (block6.is_used()) {
    ...
    USE(tmp26);
    tmp26 = ca_.UncheckedCast<Int32T>(FromConstexpr14ATElementsKind24ATconstexpr_ElementsKind_146(state_, PACKED_ELEMENTS));
  ...
  if (block8.is_used()) {
    ...
    EnsureWriteableFastElements_52(state_, compiler::TNode<Context>{tmp28}, compiler::TNode<JSArray>{tmp30});
    ...
    FastPackedArrayReverse26ATFastPackedObjectElements20UT5ATSmi10HeapObject_1191(state_, compiler::TNode<Context>{tmp28}, compiler::TNode<FixedArrayBase>{tmp33}, compiler::TNode<Smi>{tmp34});
    ca_.SetSourcePosition("../../src/builtins/array-reverse.tq", 154);
  ...
  if (block9.is_used()) {
    ...
    USE(tmp39);
    tmp39 = ca_.UncheckedCast<Int32T>(FromConstexpr14ATElementsKind24ATconstexpr_ElementsKind_146(state_, PACKED_DOUBLE_ELEMENTS));
  ...
  if (block11.is_used()) {
    ...
    FastPackedArrayReverse26ATFastPackedDoubleElements9ATfloat64_1192(state_, compiler::TNode<Context>{tmp41}, compiler::TNode<FixedArrayBase>{tmp46}, compiler::TNode<Smi>{tmp47});
    ca_.SetSourcePosition("../../src/builtins/array-reverse.tq", 158);
...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ...
    compiler::CodeAssemblerLabel label0(&ca_);
    TryFastPackedArrayReverse_36(state_, compiler::TNode<Context>{tmp0}, compiler::TNode<Object>{tmp1}, &label0);
  ...
  if (block2.is_used()) {
    ...
    compiler::TNode<Object> tmp22;
    USE(tmp22);
    tmp22 = ca_.UncheckedCast<Object>(GenericArrayReverse_35(state_, compiler::TNode<Context>{tmp17}, compiler::TNode<Object>{tmp18}));
...
void FastPackedArrayReverse23ATFastPackedSmiElements5ATSmi_1190(compiler::CodeAssemblerState* state_, compiler::TNode<Context> p_context, compiler::TNode<FixedArrayBase> p_elements, compiler::TNode<Smi> p_length) {
  ...
  if (block2.is_used()) {
    ...
    USE(tmp17);
    tmp17 = ca_.UncheckedCast<Smi>(LoadElement23ATFastPackedSmiElements5ATSmi_29(state_, compiler::TNode<Context>{tmp12}, compiler::TNode<FixedArrayBase>{tmp13}, compiler::TNode<Smi>{tmp15}));
    ca_.SetSourcePosition("../../src/builtins/array-reverse.tq", 65);
    compiler::TNode<Smi> tmp18;
    USE(tmp18);
    tmp18 = ca_.UncheckedCast<Smi>(LoadElement23ATFastPackedSmiElements5ATSmi_29(state_, compiler::TNode<Context>{tmp12}, compiler::TNode<FixedArrayBase>{tmp13}, compiler::TNode<Smi>{tmp16}));
    ca_.SetSourcePosition("../../src/builtins/array-reverse.tq", 66);
    StoreElement23ATFastPackedSmiElements5ATSmi_32(state_, compiler::TNode<Context>{tmp12}, compiler::TNode<FixedArrayBase>{tmp13}, compiler::TNode<Smi>{tmp15}, compiler::TNode<Smi>{tmp18});
    ca_.SetSourcePosition("../../src/builtins/array-reverse.tq", 67);
    StoreElement23ATFastPackedSmiElements5ATSmi_32(state_, compiler::TNode<Context>{tmp12}, compiler::TNode<FixedArrayBase>{tmp13}, compiler::TNode<Smi>{tmp16}, compiler::TNode<Smi>{tmp17});
    ca_.SetSourcePosition("../../src/builtins/array-reverse.tq", 68);
    compiler::TNode<Smi> tmp19;
    USE(tmp19);
    tmp19 = ca_.UncheckedCast<Smi>(FromConstexpr5ATSmi17ATconstexpr_int31_131(state_, 1));
    compiler::TNode<Smi> tmp20;
    USE(tmp20);
...
void FastPackedArrayReverse26ATFastPackedObjectElements20UT5ATSmi10HeapObject_1191(compiler::CodeAssemblerState* state_, compiler::TNode<Context> p_context, compiler::TNode<FixedArrayBase> p_elements, compiler::TNode<Smi> p_length) {
  ...
  if (block2.is_used()) {
    ...
    USE(tmp17);
    tmp17 = ca_.UncheckedCast<Object>(LoadElement26ATFastPackedObjectElements20UT5ATSmi10HeapObject_30(state_, compiler::TNode<Context>{tmp12}, compiler::TNode<FixedArrayBase>{tmp13}, compiler::TNode<Smi>{tmp15}));
    ca_.SetSourcePosition("../../src/builtins/array-reverse.tq", 65);
    compiler::TNode<Object> tmp18;
    USE(tmp18);
    tmp18 = ca_.UncheckedCast<Object>(LoadElement26ATFastPackedObjectElements20UT5ATSmi10HeapObject_30(state_, compiler::TNode<Context>{tmp12}, compiler::TNode<FixedArrayBase>{tmp13}, compiler::TNode<Smi>{tmp16}));
    ca_.SetSourcePosition("../../src/builtins/array-reverse.tq", 66);
    StoreElement26ATFastPackedObjectElements20UT5ATSmi10HeapObject_33(state_, compiler::TNode<Context>{tmp12}, compiler::TNode<FixedArrayBase>{tmp13}, compiler::TNode<Smi>{tmp15}, compiler::TNode<Object>{tmp18});
    ca_.SetSourcePosition("../../src/builtins/array-reverse.tq", 67);
    StoreElement26ATFastPackedObjectElements20UT5ATSmi10HeapObject_33(state_, compiler::TNode<Context>{tmp12}, compiler::TNode<FixedArrayBase>{tmp13}, compiler::TNode<Smi>{tmp16}, compiler::TNode<Object>{tmp17});
    ca_.SetSourcePosition("../../src/builtins/array-reverse.tq", 68);
    compiler::TNode<Smi> tmp19;
    USE(tmp19);
    tmp19 = ca_.UncheckedCast<Smi>(FromConstexpr5ATSmi17ATconstexpr_int31_131(state_, 1));
...
void FastPackedArrayReverse26ATFastPackedDoubleElements9ATfloat64_1192(compiler::CodeAssemblerState* state_, compiler::TNode<Context> p_context, compiler::TNode<FixedArrayBase> p_elements, compiler::TNode<Smi> p_length) {
  ...
  if (block2.is_used()) {
    ...
    compiler::TNode<Float64T> tmp17;
    USE(tmp17);
    tmp17 = ca_.UncheckedCast<Float64T>(LoadElement26ATFastPackedDoubleElements9ATfloat64_31(state_, compiler::TNode<Context>{tmp12}, compiler::TNode<FixedArrayBase>{tmp13}, compiler::TNode<Smi>{tmp15}));
    ca_.SetSourcePosition("../../src/builtins/array-reverse.tq", 65);
    compiler::TNode<Float64T> tmp18;
    USE(tmp18);
    tmp18 = ca_.UncheckedCast<Float64T>(LoadElement26ATFastPackedDoubleElements9ATfloat64_31(state_, compiler::TNode<Context>{tmp12}, compiler::TNode<FixedArrayBase>{tmp13}, compiler::TNode<Smi>{tmp16}));
    ca_.SetSourcePosition("../../src/builtins/array-reverse.tq", 66);
    StoreElement26ATFastPackedDoubleElements9ATfloat64_34(state_, compiler::TNode<Context>{tmp12}, compiler::TNode<FixedArrayBase>{tmp13}, compiler::TNode<Smi>{tmp15}, compiler::TNode<Float64T>{tmp18});
    ca_.SetSourcePosition("../../src/builtins/array-reverse.tq", 67);
    StoreElement26ATFastPackedDoubleElements9ATfloat64_34(state_, compiler::TNode<Context>{tmp12}, compiler::TNode<FixedArrayBase>{tmp13}, compiler::TNode<Smi>{tmp16}, compiler::TNode<Float64T>{tmp17});
    ca_.SetSourcePosition("../../src/builtins/array-reverse.tq", 68);
    compiler::TNode<Smi> tmp19;
    USE(tmp19);
    tmp19 = ca_.UncheckedCast<Smi>(FromConstexpr5ATSmi17ATconstexpr_int31_131(state_, 1));
