...
TNode<Int32T> LoadJSFunctionPadding_0(compiler::CodeAssemblerState* state_, TNode<JSFunction> p_o);

// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/js-function.tq?l=35&c=50
void StoreJSFunctionPadding_0(compiler::CodeAssemblerState* state_, TNode<JSFunction> p_o, TNode<Int32T> p_v);
