...
TNode<IntPtrT> CONST_TRACKING_LET_SIDE_DATA_INDEX_0(compiler::CodeAssemblerState* state_) {
  ...
  compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    ca_.Bind(&block0);
  TNode<IntPtrT> tmp0;
    tmp0 = FromConstexpr_ContextSlot_constexpr_CONST_TRACKING_LET_SIDE_DATA_INDEX_0(state_, Context::Field::CONST_TRACKING_LET_SIDE_DATA_INDEX);
  TNode<IntPtrT> tmp1;
    tmp1 = (TNode<IntPtrT>{tmp0});
  return TNode<IntPtrT>{tmp1};}
...
void StoreContextElementAndUpdateSideData_0(compiler::CodeAssemblerState* state_, TNode<Context> p_c, TNode<IntPtrT> p_i, TNode<Object> p_o) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    UpdateConstTrackingLetSideData_0(state_, TNode<Context>{p_c}, TNode<IntPtrT>{p_i}, TNode<Object>{p_o});
    std::tie(tmp0, tmp1, tmp2) = FieldSliceContextElements_0(state_, TNode<Context>{p_c}).Flatten();
    tmp3 = Convert_uintptr_intptr_0(state_, TNode<IntPtrT>{p_i});
    tmp4 = Convert_uintptr_intptr_0(state_, TNode<IntPtrT>{tmp2});
    tmp5 = CodeStubAssembler(state_).UintPtrLessThan(TNode<UintPtrT>{tmp3}, TNode<UintPtrT>{tmp4});
...
void StoreContextElementAndUpdateSideData_1(compiler::CodeAssemblerState* state_, TNode<Context> p_c, int32_t p_i, TNode<Object> p_o) {
  ...
  if (block0.is_used()) {
    ...
    UpdateConstTrackingLetSideData_0(state_, TNode<Context>{p_c}, TNode<IntPtrT>{tmp0}, TNode<Object>{p_o});
    std::tie(tmp1, tmp2, tmp3) = FieldSliceContextElements_0(state_, TNode<Context>{p_c}).Flatten();
    tmp4 = FromConstexpr_intptr_constexpr_int32_0(state_, p_i);
  ...
  if (block6.is_used()) {
    ...
    CodeStubAssembler(state_).StoreReference<Object>(CodeStubAssembler::Reference{tmp10, tmp11}, p_o);
    ca_.Goto(&block10);
  }
...
TF_BUILTIN(StoreCurrentScriptContextSlotBaseline, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    UpdateConstTrackingLetSideData_0(state_, TNode<Context>{tmp0}, TNode<IntPtrT>{tmp1}, TNode<Object>{parameter0});
    std::tie(tmp2, tmp3, tmp4) = FieldSliceContextElements_0(state_, TNode<Context>{tmp0}).Flatten();
    tmp5 = Convert_uintptr_intptr_0(state_, TNode<IntPtrT>{tmp1});
  ...
  if (block5.is_used()) {
    ca_.Bind(&block5);
    tmp8 = TimesSizeOf_Object_0(state_, TNode<IntPtrT>{tmp1});
    ...
    CodeStubAssembler(state_).StoreReference<Object>(CodeStubAssembler::Reference{tmp10, tmp11}, parameter0);
...
TF_BUILTIN(StoreScriptContextSlotBaseline, CodeStubAssembler) {
  ...
  compiler::CodeAssemblerParameterizedLabel<Context, IntPtrT, Context> block29(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, IntPtrT, Context> block30(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ca_.Goto(&block0);
  ...
  if (block15.is_used()) {
    ...
    UpdateConstTrackingLetSideData_0(state_, TNode<Context>{phi_bb15_4}, TNode<IntPtrT>{tmp19}, TNode<Object>{parameter1});
    std::tie(tmp20, tmp21, tmp22) = FieldSliceContextElements_0(state_, TNode<Context>{phi_bb15_4}).Flatten();
    ...
    ca_.Branch(tmp25, &block29, std::vector<compiler::Node*>{phi_bb15_4, phi_bb15_5, phi_bb15_4}, &block30, std::vector<compiler::Node*>{phi_bb15_4, phi_bb15_5, phi_bb15_4});
  }

  TNode<Context> phi_bb29_4;
  TNode<IntPtrT> phi_bb29_5;
  TNode<Context> phi_bb29_7;
  TNode<IntPtrT> tmp26;
  TNode<IntPtrT> tmp27;
  TNode<Object> tmp28;
  TNode<IntPtrT> tmp29;
  ...
  if (block29.is_used()) {
    ca_.Bind(&block29, &phi_bb29_4, &phi_bb29_5, &phi_bb29_7);
    tmp26 = TimesSizeOf_Object_0(state_, TNode<IntPtrT>{tmp19});
    tmp27 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{tmp21}, TNode<IntPtrT>{tmp26});
    std::tie(tmp28, tmp29) = NewReference_Object_0(state_, TNode<Object>{tmp20}, TNode<IntPtrT>{tmp27}).Flatten();
    CodeStubAssembler(state_).StoreReference<Object>(CodeStubAssembler::Reference{tmp28, tmp29}, parameter1);
    tmp30 = Undefined_0(state_);
    CodeStubAssembler(state_).Return(tmp30);
  }

  TNode<Context> phi_bb30_4;
  TNode<IntPtrT> phi_bb30_5;
  TNode<Context> phi_bb30_7;
  if (block30.is_used()) {
    ca_.Bind(&block30, &phi_bb30_4, &phi_bb30_5, &phi_bb30_7);
    CodeStubAssembler(state_).Unreachable();
  }
}
...
void UpdateConstTrackingLetSideData_0(compiler::CodeAssemblerState* state_, TNode<Context> p_c, TNode<IntPtrT> p_index, TNode<Object> p_newValue) {
  ...
  if (block4.is_used()) {
    ...
    tmp4 = CONST_TRACKING_LET_SIDE_DATA_INDEX_0(state_);
  ...
  if (block41.is_used()) {
    ...
    tmp39 = kConstTrackingLetCellConstMarker_0(state_);
    CodeStubAssembler(state_).StoreReference<Object>(CodeStubAssembler::Reference{tmp37, tmp38}, tmp39);
    ca_.Goto(&block1);
  }
  ...
  if (block24.is_used()) {
    ca_.Bind(&block24);
    tmp40 = CodeStubAssembler(state_).TaggedEqual(TNode<MaybeObject>{tmp26}, TNode<MaybeObject>{p_newValue});
  ...
  if (block46.is_used()) {
    ca_.Bind(&block46);
    std::tie(tmp41, tmp42, tmp43) = FieldSliceFixedArrayObjects_0(state_, TNode<FixedArray>{tmp10}).Flatten();
    tmp44 = Convert_uintptr_intptr_0(state_, TNode<IntPtrT>{tmp3});
    ...
    ca_.Branch(tmp46, &block51, std::vector<compiler::Node*>{}, &block52, std::vector<compiler::Node*>{});
  }
  ...
  if (block51.is_used()) {
    ca_.Bind(&block51);
    tmp47 = TimesSizeOf_Object_0(state_, TNode<IntPtrT>{tmp3});
    ...
    tmp52 = Cast_Smi_0(state_, TNode<Object>{tmp51}, &label53);
    ca_.Goto(&block57);
    if (label53.is_used()) {
      ca_.Bind(&label53);
      ca_.Goto(&block58);
  ...
  TNode<ConstTrackingLetCell> tmp54;
  if (block58.is_used()) {
    ca_.Bind(&block58);
    compiler::CodeAssemblerLabel label55(&ca_);
    tmp54 = Cast_ConstTrackingLetCell_0(state_, TNode<HeapObject>{ca_.UncheckedCast<HeapObject>(tmp51)}, &label55);
    ca_.Goto(&block61);
    if (label55.is_used()) {
      ca_.Bind(&label55);
      ca_.Goto(&block62);
  ...
  if (block61.is_used()) {
    ca_.Bind(&block61);
    tmp56 = CodeStubAssembler(state_).CallRuntime(Runtime::kInvalidateDependentCodeForConstTrackingLet, p_c, tmp54); 
    ca_.Goto(&block55);
  }
  ...
  if (block55.is_used()) {
    ca_.Bind(&block55);
    std::tie(tmp57, tmp58, tmp59) = FieldSliceFixedArrayObjects_0(state_, TNode<FixedArray>{tmp10}).Flatten();
    tmp60 = Convert_uintptr_intptr_0(state_, TNode<IntPtrT>{tmp3});
    ...
    ca_.Branch(tmp62, &block67, std::vector<compiler::Node*>{}, &block68, std::vector<compiler::Node*>{});
  }
  ...
  if (block67.is_used()) {
    ca_.Bind(&block67);
    tmp63 = TimesSizeOf_Object_0(state_, TNode<IntPtrT>{tmp3});
    ...
    tmp67 = kConstTrackingLetCellNonConstMarker_0(state_);
    CodeStubAssembler(state_).StoreReference<Object>(CodeStubAssembler::Reference{tmp65, tmp66}, tmp67);
    ca_.Goto(&block1);
  }
...
TorqueStructReference_Undefined_OR_JSFunction_OR_CallableApiObject_OR_CallableJSProxy_OR_JSBoundFunction_OR_JSWrappedFunction_0 NativeContextSlot_Undefined_OR_JSFunction_OR_CallableApiObject_OR_CallableJSProxy_OR_JSBoundFunction_OR_JSWrappedFunction_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<IntPtrT> p_index) {
  ...
  if (block0.is_used()) {
    ...
    ca_.Bind(&block2);
  return TorqueStructReference_Undefined_OR_JSFunction_OR_CallableApiObject_OR_CallableJSProxy_OR_JSBoundFunction_OR_JSWrappedFunction_0{TNode<Object>{tmp1}, TNode<IntPtrT>{tmp2}, TorqueStructUnsafe_0{}};
}
...
TorqueStructReference_Undefined_OR_JSFunction_OR_CallableApiObject_OR_CallableJSProxy_OR_JSBoundFunction_OR_JSWrappedFunction_0 ContextSlot_NativeContext_NativeContext_Undefined_OR_JSFunction_OR_CallableApiObject_OR_CallableJSProxy_OR_JSBoundFunction_OR_JSWrappedFunction_0(compiler::CodeAssemblerState* state_, TNode<NativeContext> p_context, TNode<IntPtrT> p_index) {
  ...
  if (block6.is_used()) {
    ...
    tmp7 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{tmp1}, TNode<IntPtrT>{tmp6});
    std::tie(tmp8, tmp9) = NewReference_Object_0(state_, TNode<Object>{tmp0}, TNode<IntPtrT>{tmp7}).Flatten();
    std::tie(tmp10, tmp11) = ReferenceCast_Undefined_OR_JSFunction_OR_CallableApiObject_OR_CallableJSProxy_OR_JSBoundFunction_OR_JSWrappedFunction_Object_0(state_, TorqueStructReference_Object_0{TNode<Object>{tmp8}, TNode<IntPtrT>{tmp9}, TorqueStructUnsafe_0{}}).Flatten();
    ca_.Goto(&block10);
  }
  ...
  if (block7.is_used()) {
    ...
    ca_.Bind(&block10);
  return TorqueStructReference_Undefined_OR_JSFunction_OR_CallableApiObject_OR_CallableJSProxy_OR_JSBoundFunction_OR_JSWrappedFunction_0{TNode<Object>{tmp10}, TNode<IntPtrT>{tmp11}, TorqueStructUnsafe_0{}};
}
...
TorqueStructReference_Undefined_OR_JSFunction_OR_CallableApiObject_OR_CallableJSProxy_OR_JSBoundFunction_OR_JSWrappedFunction_0 ReferenceCast_Undefined_OR_JSFunction_OR_CallableApiObject_OR_CallableJSProxy_OR_JSBoundFunction_OR_JSWrappedFunction_Object_0(compiler::CodeAssemblerState* state_, TorqueStructReference_Object_0 p_ref) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    std::tie(tmp0, tmp1) = NewReference_Undefined_OR_JSFunction_OR_CallableApiObject_OR_CallableJSProxy_OR_JSBoundFunction_OR_JSWrappedFunction_0(state_, TNode<Object>{p_ref.object}, TNode<IntPtrT>{p_ref.offset}).Flatten();
    tmp2 = CodeStubAssembler(state_).LoadReference<HeapObject>(CodeStubAssembler::Reference{tmp0, tmp1});
    tmp3 = TORQUE_CAST(TNode<Object>{tmp2});
    ca_.Goto(&block15);
  }
