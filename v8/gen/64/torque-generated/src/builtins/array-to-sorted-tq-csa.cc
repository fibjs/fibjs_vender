...
TNode<JSArray> CopyWorkArrayToNewFastJSArray_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<SortState> p_sortState, ElementsKind p_elementsKind, TNode<Smi> p_numberOfNonUndefined) {
  ...
  if (block0.is_used()) {
    ...
    tmp5 = FromConstexpr_intptr_constexpr_int31_0(state_, 72);
...
TF_BUILTIN(ArrayTimSortIntoCopy, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    tmp1 = FromConstexpr_intptr_constexpr_int31_0(state_, 88);
  ...
  if (block1.is_used()) {
    ca_.Bind(&block1);
    tmp5 = FromConstexpr_intptr_constexpr_int31_0(state_, 96);
  ...
  if (block6.is_used()) {
    ca_.Bind(&block6);
    tmp9 = FromConstexpr_intptr_constexpr_int31_0(state_, 72);
