...
TorqueStructWasmToJSResult WasmToJSWrapper_0(compiler::CodeAssemblerState* state_, TNode<WasmImportData> p_ref) {
  ...
  if (block16.is_used()) {
    ca_.Bind(&block16);
    tmp29 = FromConstexpr_intptr_constexpr_int31_0(state_, 56);
  ...
  if (block220.is_used()) {
    ...
    tmp428 = FromConstexpr_intptr_constexpr_int31_0(state_, 16);
  ...
  if (block186.is_used()) {
    ...
    tmp433 = FromConstexpr_intptr_constexpr_int31_0(state_, 24);
    tmp434 = CodeStubAssembler(state_).LoadReference<HeapObject>(CodeStubAssembler::Reference{p_ref, tmp433});
    tmp435 = FromConstexpr_intptr_constexpr_int31_0(state_, 16);
