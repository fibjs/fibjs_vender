...
class TqJSFunction : public TqJSFunctionOrBoundFunctionOrWrappedFunction {
 public:
  ...
  Value<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> GetPaddingValue(d::MemoryAccessor accessor ) const;
...
class TqWasmExportedFunctionData : public TqWasmFunctionData {
 public:
  ...
  uintptr_t GetReceiverIsFirstParamAddress() const;
  Value<uintptr_t> GetReceiverIsFirstParamValue(d::MemoryAccessor accessor ) const;
...
class TqWasmTableObject : public TqJSObject {
 public:
  ...
  uintptr_t GetPaddingForAddressType2Address() const;
  Value<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> GetPaddingForAddressType2Value(d::MemoryAccessor accessor ) const;
};
...
class TqWasmDescriptorOptions : public TqJSObject {
 public:
  inline TqWasmDescriptorOptions(uintptr_t address) : TqJSObject(address) {}
  std::vector<std::unique_ptr<ObjectProperty>> GetProperties(
      d::MemoryAccessor accessor) const override;
  const char* GetName() const override;
  void Visit(TqObjectVisitor* visitor) const override;
...
class TqObjectVisitor {
 public:
  ...
  virtual void VisitWasmDescriptorOptions(const TqWasmDescriptorOptions* object) {
    VisitJSObject(object);
  }
