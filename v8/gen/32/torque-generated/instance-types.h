  ...
  V(FIRST_HEAP_OBJECT_TYPE, 0) \
    ...
    V(FIRST_JS_RECEIVER_TYPE, 277) \
      ...
      V(FIRST_JS_OBJECT_TYPE, 280) \
        ...
        V(JS_CONTEXT_EXTENSION_OBJECT_TYPE, 2118) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/builtins/base.tq?l=616&c=1 */\
        V(JS_DATE_TYPE, 2119) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/js-objects.tq?l=142&c=1 */\
        V(JS_DATE_TIME_FORMAT_TYPE, 2120) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/js-date-time-format.tq?l=23&c=1 */\
        ...
        V(JS_DURATION_FORMAT_TYPE, 2122) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/js-duration-format.tq?l=39&c=1 */\
        V(JS_ERROR_TYPE, 2123) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/builtins/base.tq?l=618&c=1 */\
        ...
        V(JS_MESSAGE_OBJECT_TYPE, 2128) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/js-objects.tq?l=123&c=1 */\
        ...
        V(JS_STRING_ITERATOR_TYPE, 2139) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/js-objects.tq?l=169&c=1 */\
        ...
        V(JS_VALID_ITERATOR_WRAPPER_TYPE, 2151) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/js-objects.tq?l=178&c=1 */\
        V(JS_WEAK_REF_TYPE, 2152) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/js-weak-refs.tq?l=42&c=1 */\
        V(WASM_EXCEPTION_PACKAGE_TYPE, 2153) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/wasm/wasm-objects.tq?l=128&c=1 */\
        V(WASM_GLOBAL_OBJECT_TYPE, 2154) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/wasm/wasm-objects.tq?l=157&c=1 */\
        ...
        V(WASM_MEMORY_OBJECT_TYPE, 2156) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/wasm/wasm-objects.tq?l=150&c=1 */\
        V(WASM_MODULE_OBJECT_TYPE, 2157) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/wasm/wasm-objects.tq?l=130&c=1 */\
        V(WASM_SUSPENDER_OBJECT_TYPE, 2158) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/wasm/wasm-objects.tq?l=107&c=1 */\
        V(WASM_TABLE_OBJECT_TYPE, 2159) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/wasm/wasm-objects.tq?l=135&c=1 */\
        V(WASM_TAG_OBJECT_TYPE, 2160) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/wasm/wasm-objects.tq?l=172&c=1 */\
